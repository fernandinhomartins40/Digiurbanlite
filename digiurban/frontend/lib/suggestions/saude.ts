...
export const saudeSuggestions: ServiceSuggestion[] = [
  {
    ...
    suggestedFields: [
      { name: 'nome_paciente', type: 'text', label: 'Nome Completo do Paciente', required: true },
  ...
  },
  {
    ...
    requiresDocuments: true,
    suggestedFields: [
      { name: 'nome_gestante', type: 'text', label: 'Nome Completo da Gestante', required: true },
      { name: 'cpf', type: 'cpf', label: 'CPF', required: true },
      { name: 'data_nascimento', type: 'date', label: 'Data de Nascimento', required: true },
      { name: 'telefone', type: 'tel', label: 'Telefone', required: true },
  ...
  },
  {
    ...
    requiresDocuments: false,
    suggestedFields: [
      { name: 'nome_paciente', type: 'text', label: 'Nome da Pessoa a Vacinar', required: true },
      { name: 'cpf_responsavel', type: 'cpf', label: 'CPF do Responsável (se menor de idade)', required: false },
      { name: 'data_nascimento', type: 'date', label: 'Data de Nascimento', required: true },
      { name: 'telefone', type: 'tel', label: 'Telefone', required: true },
  ...
  },
  {
    ...
    requiresDocuments: true,
    suggestedFields: [
      { name: 'nome_paciente', type: 'text', label: 'Nome Completo', required: true },
      { name: 'cpf', type: 'cpf', label: 'CPF', required: true },
      { name: 'data_nascimento', type: 'date', label: 'Data de Nascimento', required: true },
      { name: 'telefone', type: 'tel', label: 'Telefone', required: true },
  ...
  },
  {
    ...
    requiresDocuments: false,
    suggestedFields: [
      { name: 'nome_paciente', type: 'text', label: 'Nome da Paciente', required: true },
      { name: 'cpf', type: 'cpf', label: 'CPF', required: true },
      { name: 'data_nascimento', type: 'date', label: 'Data de Nascimento', required: true },
      { name: 'telefone', type: 'tel', label: 'Telefone', required: true },
  ...
  },
  {
    ...
    suggestedFields: [
      ...
      { name: 'data_nascimento', type: 'date', label: 'Data de Nascimento', required: true },
      { name: 'telefone', type: 'tel', label: 'Telefone', required: true },
      { name: 'nome_responsavel', type: 'text', label: 'Nome do Responsável (se aplicável)', required: false },
      { name: 'tipo_atendimento', type: 'select', label: 'Tipo de Atendimento', required: true },
  ...
  },
  {
    ...
    requiresDocuments: false,
    suggestedFields: [
      { name: 'nome_bebe', type: 'text', label: 'Nome do Bebê', required: true },
  ...
  },
  {
    ...
    requiresDocuments: true,
    suggestedFields: [
      { name: 'nome_acompanhante', type: 'text', label: 'Nome do Acompanhante', required: true },
  ...
  },
  {
    ...
    suggestedFields: [
      { name: 'nome_paciente', type: 'text', label: 'Nome do Paciente', required: true },
      { name: 'cpf', type: 'cpf', label: 'CPF (ou do responsável)', required: true },
      { name: 'data_nascimento', type: 'date', label: 'Data de Nascimento', required: true },
      { name: 'telefone', type: 'tel', label: 'Telefone', required: true },
      { name: 'idade_paciente', type: 'number', label: 'Idade do Paciente', required: true },
