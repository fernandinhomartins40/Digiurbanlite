    ...
    <div ref={dropdownRef} className="w-full min-w-0 max-w-full relative">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 border border-blue-200 rounded-lg bg-blue-50/25 focus:ring-2 focus:ring-teal-500 focus:border-transparent"
        />
      </div>

      {/* Dropdown */}
      {isOpen && (
        <div className="absolute z-10 w-full min-w-0 mt-2 bg-white border border-blue-100 rounded-lg shadow-lg max-h-64 overflow-y-auto overflow-x-hidden">
          {filteredOptions.length === 0 ? (
            ...
            filteredOptions.map(option => (
              <button
                ...
                className={`
                  w-full px-4 py-3 text-left hover:bg-blue-50/50 transition-colors border-b border-gray-100 last:border-b-0
