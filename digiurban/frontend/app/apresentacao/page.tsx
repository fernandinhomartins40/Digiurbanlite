      ...
      <div className="w-[38%] h-full z-10 relative flex items-center justify-center">
        ...
        <div className="w-[260px] bg-white rounded-[14px] shadow-xl p-6 border-t-4 border-[#0fffbf] z-20">
          ...
          <div className="w-full h-1.5 bg-slate-100 rounded-full overflow-hidden mb-1.5">
            <div className="h-full w-[85%] bg-gradient-to-r from-[#0f6fbe] to-[#0fffbf] rounded-full" />
          </div>
          <p className="text-[10px] text-slate-400 text-right">Meta Mensal: 85%</p>
        </div>
      ...
      <div className="w-1/2 h-full bg-gradient-to-br from-[#193642] via-[#193642] to-[#0d2a34] flex flex-col justify-center pl-12 pr-16 relative shadow-[-10px_0_30px_-10px_rgba(0,0,0,0.3)]">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl text-blue-100/80 leading-relaxed border-l-4 border-[#0fffbf] pl-6 mb-10">
            &ldquo;DigiUrban é a plataforma completa de gestão pública digital que conecta <strong className="text-white">cidadãos</strong>, <strong className="text-white">servidores</strong> e <strong className="text-white">gestores</strong> em tempo real — do protocolo ao relatório, da solicitação à avaliação.&rdquo;
          </p>
...
function SlidePortais() {
  return (
    <div className="w-full h-full flex flex-col bg-white relative overflow-hidden">
      ...
      {/* 3 Cards */}
      <div className="flex-1 px-16 pb-14 grid grid-cols-3 gap-8">
        {/* Portal do Cidadão */}
        <div className="relative rounded-2xl bg-sky-50 border-t-[8px] border-[#0f6fbe] p-8 flex flex-col items-center shadow-lg overflow-hidden">
          <div className="w-[90px] h-[90px] rounded-full bg-white flex items-center justify-center mb-6 shadow-md">
            <Smartphone className="w-9 h-9 text-[#0f6fbe]" />
          </div>
          <h3 className="text-2xl font-bold text-[#193642] mb-1">Portal do Cidadão</h3>
          <span className="inline-block px-3 py-1 bg-sky-200 text-sky-800 rounded-full text-xs font-bold mb-8 uppercase tracking-wide">
            Mobile-first / PWA
          </span>
        ...
        <div className="relative rounded-2xl bg-slate-50 border-t-[8px] border-[#193642] p-8 flex flex-col items-center shadow-lg overflow-hidden">
          <div className="w-[90px] h-[90px] rounded-full bg-white flex items-center justify-center mb-6 shadow-md">
            <UserCog className="w-9 h-9 text-[#193642]" />
          </div>
          <h3 className="text-2xl font-bold text-[#193642] mb-1">Painel Administrativo</h3>
          <span className="inline-block px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-bold mb-8 uppercase tracking-wide">
            Desktop / Servidor
          </span>
          <ul className="text-left w-full space-y-3 text-slate-700">
            <li className="flex items-start">
        ...
        {/* Painel Super Admin */}
        <div className="relative rounded-2xl bg-[#1e293b] border-t-[8px] border-[#0fffbf] p-8 flex flex-col items-center shadow-xl overflow-hidden">
          <div className="w-[90px] h-[90px] rounded-full bg-slate-700 flex items-center justify-center mb-6 border border-slate-600">
            <Settings className="w-9 h-9 text-[#0fffbf]" />
          </div>
          <h3 className="text-2xl font-bold text-white mb-1">Painel Super Admin</h3>
          <span className="inline-block px-3 py-1 bg-teal-900 text-[#0fffbf] rounded-full text-xs font-bold mb-8 uppercase tracking-wide">
          ...
          <div className="bg-white rounded-lg shadow-xl border border-slate-200 h-full flex flex-col overflow-hidden">
            ...
            <div className="flex flex-1 min-h-0">
              ...
              <div className="flex-1 bg-slate-100 p-4 flex flex-col gap-3 min-h-0">
                ...
                {/* FAB */}
                <div className="absolute bottom-12 left-[calc(58.3%-40px)] w-8 h-8 bg-[#193642] rounded-full shadow-lg flex items-center justify-center text-white">
      ...
      <div className="px-12 py-4">
        <div className="grid grid-cols-5 gap-2.5">
          {departments.map(({ icon: Icon, name, bg, color }) => (
            <div key={name} className="flex items-center gap-2.5 bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 hover:border-slate-300 hover:-translate-y-0.5 transition-all">
        ...
        <div className="h-full rounded-2xl bg-teal-50 border border-teal-200 border-l-[6px] border-l-[#0fffbf] p-5 relative overflow-hidden">
          ...
          <div className="grid grid-cols-4 gap-4 relative z-10">
            {healthCards.map(({ icon: Icon, title, iconBg, iconColor, items }) => (
              <div key={title} className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm hover:-translate-y-1 hover:shadow-md hover:border-teal-200 transition-all">
                <div className="flex items-center mb-3">
      ...
      <div className="flex-1 px-12 pb-10">
        ...
        <div className="grid grid-cols-3 gap-5 mb-5">
          {features.slice(0, 3).map(({ icon: Icon, badge, title, color, badgeBg, iconBg, iconColor, bgIcon: BgIcon, bgIconColor, items }) => (
            <div key={title} className={`relative bg-white rounded-2xl border-t-[5px] ${color} p-6 shadow-lg overflow-hidden hover:-translate-y-1 hover:shadow-xl transition-all`}>
              {/* Background icon */}
    ...
    <div className="w-full h-full flex relative overflow-hidden">
      ...
      <div className="w-[60%] bg-slate-50 flex flex-col px-10 py-8 relative">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6 items-center">
          {plans.map(({ name, subtitle, variant, items }) => (
            <div
              key={name}
              className={`rounded-xl p-4 flex flex-col text-center relative ${
                variant === 'featured'
                  ? 'bg-white border-2 border-[#0fffbf] shadow-lg shadow-[#0fffbf]/10 scale-105 z-10 min-h-[280px]'
                  : variant === 'enterprise'
                    ? 'bg-[#193642] text-white border border-[#193642] min-h-[260px]'
                    : 'bg-white border border-slate-200 border-t-4 border-t-slate-400 min-h-[240px]'
              }`}
            >
              {variant === 'featured' && (
              ...
              <h3 className={`text-lg font-bold mt-1 ${
                variant === 'featured' ? 'text-[#0fffbf]' : variant === 'enterprise' ? 'text-white' : 'text-slate-700'
              }`}>
                {name}
              </h3>
              <p className={`text-[10px] uppercase tracking-wide mb-4 ${
    ...
    <div className="w-full h-full flex relative overflow-hidden">
      ...
      <div className="flex-1 bg-slate-50 p-10 flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-3.5 flex-1">
          {values.map(({ icon: Icon, title, desc, iconBg, iconColor }) => (
            <div key={title} className="bg-white rounded-xl border border-slate-200 p-3.5 flex items-start shadow-sm hover:-translate-y-0.5 hover:shadow-md hover:border-slate-300 transition-all">
          ...
          <div className="col-span-2 bg-teal-50 rounded-xl border border-teal-200 p-3.5 flex items-start hover:-translate-y-0.5 hover:shadow-md transition-all">
      ...
      <div className="w-[420px] bg-gradient-to-br from-[#193642] via-[#193642] to-[#0d2a34] p-10 flex flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 pt-5 border-t border-white/10 mt-4 text-center">
          ...
          <p className="text-white font-bold text-lg">contato@digiurban.com.br</p>
        </div>
      </div>
    </div>
  );
...
function SlideValor() {
  ...
  return (
    <div className="w-full h-full flex relative overflow-hidden">
      {/* Left dark */}
      <div className="w-[45%] bg-gradient-to-br from-[#193642] to-[#0d2a34] flex flex-col justify-center px-14 relative">
        <div className="absolute top-0 right-0 w-1 h-full bg-gradient-to-b from-[#0f6fbe] to-[#0fffbf]" />
        <span className="text-xs font-bold text-white/40 tracking-[3px] uppercase mb-4">Bloco 09</span>
      ...
      <div className="flex-1 bg-white flex flex-col justify-center px-12">
        <div className="grid grid-cols-2 gap-5">
          {values.map(({ icon: Icon, title, desc }, i) => (
            <div key={i} className="flex items-start gap-4 group">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#0f6fbe]/10 to-[#0fffbf]/10 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                <Icon className="w-5 h-5 text-[#0f6fbe]" />
              </div>
              <div>
                <h3 className="text-sm font-bold text-[#193642] mb-0.5">{title}</h3>
...
const SLIDES = [
  ...
  { id: 'valor', title: 'Por que DigiUrban', component: SlideValor },
];
