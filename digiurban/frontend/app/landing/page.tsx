...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-20 sm:pt-28 pb-12 sm:pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#0f6fbe] via-[#0f6fbe] to-[#193642] relative overflow-hidden">
        {/* Decorative elements */}
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6 sm:mb-8">
                ...
                <span className="text-xs sm:text-sm text-white font-medium">Plataforma Digital de Serviços Municipais</span>
              </div>
              ...
              <p className="text-base sm:text-lg text-white/80 mb-8 sm:mb-10 leading-relaxed max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-12">
                <Link
                  href="/cidadao/login"
                  className="inline-flex items-center justify-center gap-2 bg-[#0fffbf] hover:bg-[#0de6a9] text-[#193642] px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl hover:scale-105"
                >
                  Acessar Plataforma
              ...
              <div className="flex flex-wrap items-center gap-4 sm:gap-8 text-xs sm:text-sm">
                <div className="flex items-center gap-2 text-white/90">
                  <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#0fffbf]" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-[#0f6fbe] mb-1 sm:mb-2">12.543</div>
              <div className="text-xs sm:text-sm text-gray-600">Protocolos processados</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-[#0f6fbe] mb-1 sm:mb-2">98%</div>
              <div className="text-xs sm:text-sm text-gray-600">Satisfação dos usuários</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-[#0f6fbe] mb-1 sm:mb-2">24/7</div>
              <div className="text-xs sm:text-sm text-gray-600">Disponibilidade</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-[#0f6fbe] mb-1 sm:mb-2">15+</div>
              <div className="text-xs sm:text-sm text-gray-600">Secretarias integradas</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Como Funciona */}
      <section id="como-funciona" className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-gray-50">
        <div className="container mx-auto">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#193642] mb-3 sm:mb-4">
            ...
            <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
              <div className="relative">
                ...
                <div className="relative bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-100 hover:shadow-lg transition-shadow">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-[#0f6fbe] to-[#0fffbf] flex items-center justify-center mb-4 sm:mb-6">
                    <span className="text-lg sm:text-xl font-bold text-white">1</span>
                  </div>
                  <h3 className="text-lg sm:text-xl font-semibold text-[#193642] mb-2 sm:mb-3">Cadastre-se gratuitamente</h3>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 text-xs sm:text-sm text-gray-600">
                      <CheckCircle2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0fffbf] flex-shrink-0" />
              ...
              <div className="relative">
                ...
                <div className="relative bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-100 hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-[#193642] mb-2 sm:mb-3">Solicite serviços</h3>
                  <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-3 sm:mb-4">
              ...
              <div className="relative">
                <div className="relative bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-100 hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-[#193642] mb-2 sm:mb-3">Acompanhe em tempo real</h3>
                  <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-3 sm:mb-4">
      ...
      {/* Serviços */}
      <section id="servicos" className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="container mx-auto">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#193642] mb-3 sm:mb-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                <div key={index} className="group bg-white rounded-xl p-5 sm:p-6 border border-gray-100 hover:border-[#0fffbf]/30 hover:shadow-lg transition-all">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-gradient-to-br from-[#0f6fbe]/10 to-[#0fffbf]/10 flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform">
                    <service.icon className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: service.color }} />
                  </div>
                  <h3 className="text-base sm:text-lg font-semibold text-[#193642] mb-2 sm:mb-3">{service.title}</h3>
                  <ul className="space-y-1.5 sm:space-y-2">
                    {service.items.map((item, i) => (
                      <li key={i} className="flex items-start gap-2 text-xs sm:text-sm text-gray-600">
                        <div className="w-1 h-1 rounded-full bg-[#0fffbf] mt-1.5 flex-shrink-0"></div>
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
      ...
      {/* Benefícios */}
      <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto">
          <div className="max-w-7xl mx-auto">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-100">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#0f6fbe]/10 flex items-center justify-center mb-4 sm:mb-6">
                  <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-[#0f6fbe]" />
                </div>
                <h3 className="text-lg sm:text-xl font-semibold text-[#193642] mb-2 sm:mb-3">Economia de tempo</h3>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-100">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#0fffbf]/10 flex items-center justify-center mb-4 sm:mb-6">
                  <Smartphone className="w-5 h-5 sm:w-6 sm:h-6 text-[#0fffbf]" />
                </div>
                <h3 className="text-lg sm:text-xl font-semibold text-[#193642] mb-2 sm:mb-3">Acesso multiplataforma</h3>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  Use em qualquer dispositivo: computador, tablet ou smartphone. Interface responsiva e intuitiva.
                </p>
              </div>

              <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-100 sm:col-span-2 lg:col-span-1">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#0f6fbe]/10 flex items-center justify-center mb-4 sm:mb-6">
                  <Shield className="w-5 h-5 sm:w-6 sm:h-6 text-[#0f6fbe]" />
                </div>
                <h3 className="text-lg sm:text-xl font-semibold text-[#193642] mb-2 sm:mb-3">Segurança garantida</h3>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
      ...
      {/* Segurança */}
      <section id="seguranca" className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 bg-white border-t border-gray-100">
        <div className="container mx-auto">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div>
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#193642] mb-4 sm:mb-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[#0fffbf]/10 flex items-center justify-center flex-shrink-0">
                      <Lock className="w-4 h-4 sm:w-5 sm:h-5 text-[#0fffbf]" />
                    </div>
                    <div>
                      <h4 className="text-sm sm:text-base font-semibold text-[#193642] mb-1">Criptografia de ponta a ponta</h4>
                      <p className="text-xs sm:text-sm text-gray-600">Todos os dados são transmitidos e armazenados com criptografia avançada.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[#0fffbf]/10 flex items-center justify-center flex-shrink-0">
                      <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-[#0fffbf]" />
                    </div>
                    <div>
                      <h4 className="text-sm sm:text-base font-semibold text-[#193642] mb-1">Conformidade LGPD</h4>
                      <p className="text-xs sm:text-sm text-gray-600">Total adequação à Lei Geral de Proteção de Dados Pessoais.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[#0fffbf]/10 flex items-center justify-center flex-shrink-0">
                      <Bell className="w-4 h-4 sm:w-5 sm:h-5 text-[#0fffbf]" />
                    </div>
                    <div>
                      <h4 className="text-sm sm:text-base font-semibold text-[#193642] mb-1">Controle total</h4>
                      <p className="text-xs sm:text-sm text-gray-600">Você tem acesso e controle completo sobre seus dados pessoais.</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="relative mt-8 md:mt-0">
                ...
                <div className="relative bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-gray-100 shadow-lg">
                  <div className="flex items-center justify-between mb-4 sm:mb-6">
                    <h4 className="text-sm sm:text-base font-semibold text-[#193642]">Proteção de Dados</h4>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#0f6fbe] via-[#0f6fbe] to-[#193642] relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-white/80 mb-8 sm:mb-10 max-w-2xl mx-auto px-4">
              Acesse agora a plataforma e experimente a praticidade dos serviços municipais digitais.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <Link
                href="/cidadao/login"
                className="inline-flex items-center justify-center gap-2 bg-[#0fffbf] hover:bg-[#0de6a9] text-[#193642] px-8 sm:px-10 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg transition-all shadow-lg hover:shadow-xl hover:scale-105"
              >
      ...
      {/* Footer */}
      <footer className="bg-[#193642] text-white py-10 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto">
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-8 sm:mb-10 lg:mb-12">
            ...
            <div>
              <h4 className="text-sm sm:text-base font-semibold mb-3 sm:mb-4">Serviços</h4>
            ...
            <div>
              <h4 className="text-sm sm:text-base font-semibold mb-3 sm:mb-4">Acesso</h4>
              <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
