...
import { CompletingProtocolView } from '@/src/components/admin/protocol/CompletingProtocolView'
import { ArchivedProtocolView } from '@/src/components/admin/protocol/ArchivedProtocolView'

// Componentes para modo ACTIVE
import { ProtocolHeader } from '@/src/components/admin/protocol/ProtocolHeader'
import { WorkflowProgressBar } from '@/src/components/admin/protocol/WorkflowProgressBar'
import { StageFocusCard } from '@/src/components/admin/protocol/StageFocusCard'
import { DynamicProtocolTabs } from '@/src/components/admin/protocol/DynamicProtocolTabs'
import { CompactSLACard } from '@/src/components/admin/protocol/CompactSLACard'
import { ProtocolSummaryTab } from '@/src/components/admin/protocol/ProtocolSummaryTab'
import { ProtocolDocumentsUnified } from '@/src/components/admin/protocol/ProtocolDocumentsUnified'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <ForwardProtocolDialog
        ...
        protocolId={protocolId}
        currentDepartmentId={protocol.departmentId || protocol.department?.id}
        onSuccess={() => {
