    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        const microSystems = Object.values(allMSConfigs).filter(
          (ms: any) => ms.departmentSlug === 'turismo'
        );
        ...
        return (
          <div className="space-y-4">
            {/* Header da seção */}
            <div className="flex items-center gap-3 border-b-2 pb-4 border-teal-500">
              ...
              <Badge className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white px-4 py-2 text-base shadow-lg">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {microSystems.map((msConfig: any) => (
                <Card
                  key={msConfig.id}
                  className="cursor-pointer hover:shadow-2xl transition-all duration-300 hover:scale-[1.03] border-2 border-teal-200 bg-gradient-to-br from-teal-50 via-cyan-50 to-teal-50 dark:from-teal-950 dark:via-cyan-950 dark:to-teal-950 relative overflow-hidden group"
                ...
                >
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between mb-3">
                      <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center shadow-lg text-white">
                        {msConfig.icon}
                      </div>
                      <Badge variant="secondary" className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white border-0 shadow-md">
                        SUPER APP
                      </Badge>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="bg-teal-50 dark:bg-teal-950/50 rounded-lg p-3 border border-teal-200 dark:border-teal-800">
                        <p className="text-xs text-center text-teal-700 dark:text-teal-300 font-medium">
        ...
        {suggestionsLoading ? (
          ...
          <Card className="border-green-200 bg-green-50/50">
            <CardContent className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <Button
                onClick={() => router.push('/admin/servicos/novo?departmentCode=turismo&serviceType=COM_DADOS')}
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <Button
                      ...
                      onClick={() => router.push(buildServiceCreationUrl('turismo', suggestion))}
                    >
                      <Plus className="h-4 w-4 mr-2" />
                      Criar este Serviço
                    </Button>
              ...
              <Card className="border-dashed border-2 border-blue-300 bg-gradient-to-br from-blue-50 to-indigo-50 hover:shadow-lg transition-all">
                <CardContent className="flex flex-col items-center justify-center p-12 h-full min-h-[300px]">
                  ...
                  <Button
                    ...
                    onClick={() => router.push(`/admin/secretarias/turismo/sugestoes`)}
                  >
