      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex-1">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 flex items-center flex-wrap gap-3">
            <Camera className="h-7 w-7 md:h-8 md:w-8 text-blue-600 flex-shrink-0" />
        ...
        {servicesLoading ? (
          ...
          <Card className="border-green-200 bg-green-50">
            <CardContent className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <Button
                onClick={() => router.push('/admin/servicos/novo?departmentCode=turismo&serviceType=SEM_DADOS')}
