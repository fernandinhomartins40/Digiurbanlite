  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Gestão de atletas cadastrados no município</p>
      </div>
      <Tabs defaultValue="cadastrados" className="w-full">
        ...
        <TabsContent value="cadastrados" className="mt-6">
          <ModulePageTemplate config={athleteConfig} departmentType="esportes" />
        </TabsContent>
        <TabsContent value="pendentes" className="mt-6">
          <PendingProtocolsList moduleType="CADASTRO_ATLETAS" moduleName="Cadastro de Atletas" />
        </TabsContent>
      </Tabs>
    </div>
  );
