    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        const microSystems = Object.values(allMSConfigs).filter(
          (ms: any) => ms.departmentSlug === 'esportes'
        );
        ...
        return (
          <div className="space-y-4">
            {/* Header da seção */}
            <div className="flex items-center gap-3 border-b-2 pb-4 border-orange-500">
              ...
              <Badge className="bg-gradient-to-r from-orange-500 to-amber-600 text-white px-4 py-2 text-base shadow-lg">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {microSystems.map((msConfig: any) => (
                <Card
                  key={msConfig.id}
                  className="cursor-pointer hover:shadow-2xl transition-all duration-300 hover:scale-[1.03] border-2 border-orange-200 bg-gradient-to-br from-orange-50 via-amber-50 to-orange-50 dark:from-orange-950 dark:via-amber-950 dark:to-orange-950 relative overflow-hidden group"
                ...
                >
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between mb-3">
                      <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center shadow-lg text-white">
                        {msConfig.icon}
                      </div>
                      <Badge variant="secondary" className="bg-gradient-to-r from-orange-500 to-amber-600 text-white border-0 shadow-md">
                        SUPER APP
                      </Badge>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex gap-2 flex-wrap justify-center">
                        ...
                        {msConfig.hasWorkflow && (
                          <Badge variant="outline" className="text-xs bg-white/70 dark:bg-black/30 border-amber-300">
                            Workflow
                          </Badge>
                        )}
                        {msConfig.hasReports && (
