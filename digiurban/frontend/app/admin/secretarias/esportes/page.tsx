  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card exemplo 1: Inscrição em Escolinha Esportiva */}
          <Card className="border-blue-200 bg-blue-50/50 hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-lg flex items-center gap-2">
              ...
              <CardDescription>
                Inscreva-se em escolinhas e programas esportivos
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="text-xs text-muted-foreground">
                  ...
                  <ul className="mt-2 space-y-1">
                    <li>• Dados do atleta</li>
                    <li>• Modalidade</li>
                    <li>• Categoria/Idade</li>
                ...
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => router.push('/admin/servicos/novo?departmentCode=esportes&serviceType=COM_DADOS&template=inscricao-escolinha')}
                >
                  Criar este Serviço
                </Button>
              </div>
          ...
          {/* Card exemplo 2: Reserva de Espaço Esportivo */}
          <Card className="border-green-200 bg-green-50/50 hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>
                Reserve quadras e espaços esportivos municipais
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                ...
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => router.push('/admin/servicos/novo?departmentCode=esportes&serviceType=COM_DADOS&template=reserva-espaco')}
                >
                  Criar este Serviço
                </Button>
              </div>
          ...
          <Card className="border-dashed border-2 border-gray-300 hover:border-blue-500 transition-colors">
            <CardContent className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <Button
                variant="outline"
                onClick={() => router.push('/admin/servicos?serviceType=COM_DADOS&departmentCode=esportes')}
              >
                Ver Todos
              </Button>
            </CardContent>
