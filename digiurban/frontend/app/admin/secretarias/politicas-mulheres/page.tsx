                ...
                >
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <Badge className="mb-2 bg-purple-600 text-white">Módulo COM_DADOS</Badge>
                  ...
                  <CardContent>
                    <div className="text-sm space-y-2">
                      ...
                      <div className="flex justify-between items-center p-2 bg-purple-50 rounded">
                        ...
                        <span className="font-semibold text-purple-700">{module.stats?.pending || 0}</span>
                      </div>
                    ...
                    <Button className="w-full mt-4 group-hover:bg-purple-600 transition-colors" variant="outline">
