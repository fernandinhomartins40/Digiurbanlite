  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card exemplo 1: Registro de Ocorrência (BO) */}
          <Card className="border-blue-200 bg-blue-50/50 hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-lg flex items-center gap-2">
                <Shield className="h-5 w-5 text-blue-600" />
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => router.push('/admin/servicos/novo?departmentCode=seguranca-publica&serviceType=COM_DADOS&template=registro-ocorrencia')}
                >
                  Criar este Serviço
                </Button>
              </div>
          ...
          {/* Card exemplo 2: Solicitação de Ronda Policial */}
          <Card className="border-green-200 bg-green-50/50 hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>
                Solicite ronda em área específica
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                ...
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => router.push('/admin/servicos/novo?departmentCode=seguranca-publica&serviceType=COM_DADOS&template=solicitacao-ronda')}
                >
                  Criar este Serviço
                </Button>
              </div>
          ...
          <Card className="border-dashed border-2 border-gray-300 hover:border-blue-500 transition-colors">
            <CardContent className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <Button
                variant="outline"
                onClick={() => router.push('/admin/servicos?serviceType=COM_DADOS&departmentCode=seguranca-publica')}
              >
                Ver Todos
              </Button>
            </CardContent>
