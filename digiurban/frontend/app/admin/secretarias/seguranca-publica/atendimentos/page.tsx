...
import { securityAttendanceConfig } from '@/lib/module-configs/seguranca-publica';
    ...
    <div className="space-y-6">
      <Tabs defaultValue="cadastrados">
        ...
        <TabsContent value="cadastrados">
          <ModulePageTemplate
            config={securityAttendanceConfig}
        ...
        <TabsContent value="pendentes">
          <PendingProtocolsList
            moduleType="SECURITY_ATTENDANCE"
            moduleName="Atendimentos de Segurança"
          />
        </TabsContent>
      </Tabs>
    </div>
