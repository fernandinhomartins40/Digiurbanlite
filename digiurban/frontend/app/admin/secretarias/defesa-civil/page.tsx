            ...
            modules.map((module: any, index: number) => {
              ...
              return (
                <Card
                  ...
                  onClick={() => router.push(`/admin/secretarias/defesa-civil/${module.moduleType}`)}
                >
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <Badge className="mb-2 bg-orange-600 text-white">Módulo COM_DADOS</Badge>
                  ...
                  <CardContent>
                    <div className="text-sm space-y-2">
                      ...
                      <div className="flex justify-between items-center p-2 bg-orange-50 rounded">
                        ...
                        <span className="font-semibold text-orange-700">{module.stats?.pending || 0}</span>
                      </div>
                    ...
                    <Button className="w-full mt-4 group-hover:bg-orange-600 transition-colors" variant="outline">
      ...
      <div>
        ...
        {servicesLoading ? (
          ...
          <Card
            ...
            onClick={() => router.push('/admin/secretarias/defesa-civil/servicos-gerais')}
          >
            <CardHeader>
          ...
          <Card className="border-green-200 bg-green-50">
            <CardContent className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <Button
                onClick={() => router.push('/admin/servicos/novo?departmentCode=DEFESA_CIVIL&serviceType=SEM_DADOS')}
