...
import { programasHabitacionaisConfig } from '@/lib/module-configs/habitacao';
    ...
    <div className="space-y-6">
      <Tabs defaultValue="cadastrados" className="w-full">
        ...
        <TabsContent value="cadastrados" className="mt-6">
          <ModulePageTemplate
            config={programasHabitacionaisConfig}
        ...
        <TabsContent value="pendentes" className="mt-6">
          <PendingProtocolsList
            moduleType="PROGRAMAS_HABITACIONAIS"
            moduleName="Programas Habitacionais"
          />
        </TabsContent>
      </Tabs>
    </div>
