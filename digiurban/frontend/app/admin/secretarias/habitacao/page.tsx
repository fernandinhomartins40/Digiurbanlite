    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        const microSystems = Object.values(allMSConfigs).filter(
          (ms: any) => ms.departmentSlug === 'habitacao'
        );
        ...
        return (
          <div className="space-y-4">
            {/* Header da seção */}
            <div className="flex items-center gap-3 border-b-2 pb-4 border-cyan-500">
              <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-cyan-500 to-sky-600 flex items-center justify-center shadow-lg">
              ...
              <Badge className="bg-gradient-to-r from-cyan-500 to-sky-600 text-white px-4 py-2 text-base shadow-lg">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {microSystems.map((msConfig: any) => (
                <Card
                  key={msConfig.id}
                  className="cursor-pointer hover:shadow-2xl transition-all duration-300 hover:scale-[1.03] border-2 border-cyan-200 bg-gradient-to-br from-cyan-50 via-sky-50 to-cyan-50 dark:from-cyan-950 dark:via-sky-950 dark:to-cyan-950 relative overflow-hidden group"
                ...
                >
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between mb-3">
                      <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-cyan-500 to-sky-600 flex items-center justify-center shadow-lg text-white">
                        {msConfig.icon}
                      </div>
                      <Badge variant="secondary" className="bg-gradient-to-r from-cyan-500 to-sky-600 text-white border-0 shadow-md">
                        SUPER APP
                      </Badge>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="bg-cyan-50 dark:bg-cyan-950/50 rounded-lg p-3 border border-cyan-200 dark:border-cyan-800">
                      ...
                      <div className="flex gap-2 flex-wrap justify-center">
                        <Badge variant="outline" className="text-xs bg-white/70 dark:bg-black/30 border-cyan-300">
                          Dashboard
                        </Badge>
                        {msConfig.hasWorkflow && (
                          <Badge variant="outline" className="text-xs bg-white/70 dark:bg-black/30 border-sky-300">
                            Workflow
                          </Badge>
                        )}
                        {msConfig.hasReports && (
            ...
            modules.map((module: any, index: number) => {
              ...
              return (
                <Card
                  ...
                  onClick={() => router.push(`/admin/secretarias/habitacao/${module.moduleType}`)}
                >
                  <CardHeader>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card
            ...
            onClick={() => router.push('/admin/secretarias/habitacao/servicos-gerais')}
          >
            <CardHeader>
              <CardTitle className="text-lg flex items-center gap-2">
