...
import { healthTransportRequestConfig } from '@/lib/module-configs/saude';
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Gestão de solicitações de transporte para pacientes
        </p>
      </div>
      ...
      <Tabs defaultValue="cadastrados" className="w-full">
        ...
        <TabsContent value="cadastrados" className="mt-6">
          <ModulePageTemplate
            config={healthTransportRequestConfig}
        ...
        <TabsContent value="pendentes" className="mt-6">
          <PendingProtocolsList
            ...
            moduleName="Transporte de Pacientes"
          />
        </TabsContent>
      </Tabs>
    </div>
