...
export default function SecretariaTransportesTransitoPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <SecretariaModulosSection slug="transportes-transito" departmentName="Transportes e Trânsito" />
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    ...
                    <div className="p-1.5 bg-blue-100 rounded">
                      ...
                      <div className="text-[9px] text-blue-800 uppercase tracking-wider">
                        Pend
                      </div>
                    </div>
                    ...
                    <div className="text-xs text-muted-foreground">
                      ...
                      <ul className="mt-2 space-y-1">
                        ...
                        {suggestion.suggestedFields.length > 4 && (
                          <li className="text-blue-700">+ {suggestion.suggestedFields.length - 4} campos adicionais</li>
                        )}
                      </ul>
                    </div>
