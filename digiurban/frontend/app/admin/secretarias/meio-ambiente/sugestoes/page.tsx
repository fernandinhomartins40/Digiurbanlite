...
export default function MeioAmbienteSugestoesPage() {
  const router = useRouter();
  const { suggestions, isLoading } = useServiceSuggestions('meio-ambiente');
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="mb-8">
        <Button
          variant="ghost"
          onClick={() => router.push('/admin/secretarias/meio-ambiente')}
          className="mb-4"
        >
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Explore todas as {suggestions.length} sugestões disponíveis para Meio Ambiente
            </p>
          </div>
        </div>
      </div>
