...
export default function SecretariaMeioAmbientePage() {
  ...
  } = useServiceSuggestions('meio-ambiente');
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex-1">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 flex items-center flex-wrap gap-3">
            <Leaf className="h-7 w-7 md:h-8 md:w-8 text-green-600 flex-shrink-0" />
        ...
        <Badge variant="outline" className="text-green-600 border-green-200 self-start md:self-auto">
          Meio Ambiente
        </Badge>
      </div>
      ...
      <div>
        ...
        {servicesLoading ? (
          ...
          <Card
            ...
            onClick={() => router.push('/admin/secretarias/meio-ambiente/servicos-gerais')}
          >
            <CardHeader>
        ...
        {!servicesLoading && services.filter((s: any) => s.serviceType === 'SEM_DADOS').length === 0 && (
          <Card className="border-green-200 bg-green-50">
            <CardContent className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <Button
                onClick={() => router.push('/admin/servicos/novo?departmentCode=meio-ambiente&serviceType=SEM_DADOS')}
                className="bg-blue-600 hover:bg-blue-700"
              >
                <Plus className="h-4 w-4 mr-2" />
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <Button
                      ...
                      onClick={() => router.push(buildServiceCreationUrl('meio-ambiente', suggestion))}
                    >
                      <Plus className="h-4 w-4 mr-2" />
                      Criar este Serviço
                    </Button>
              ...
              <Card className="border-dashed border-2 border-blue-300 bg-gradient-to-br from-blue-50 to-indigo-50 hover:shadow-lg transition-all">
                <CardContent className="flex flex-col items-center justify-center p-12 h-full min-h-[300px]">
                  ...
                  <Button
                    ...
                    onClick={() => router.push(`/admin/secretarias/meio-ambiente/sugestoes`)}
                  >
...
{/* Modal de Seleção de Serviços */}
      <ServiceSelectorModal
        ...
        departmentFilter="meio-ambiente"
      />
    </div>
  );
}
