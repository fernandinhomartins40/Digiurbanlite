                ...
                >
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <Badge className="mb-2 bg-yellow-600 text-white">Módulo COM_DADOS</Badge>
                  ...
                  <CardContent>
                    ...
                    <Button className="w-full mt-4 group-hover:bg-yellow-600 transition-colors" variant="outline">
