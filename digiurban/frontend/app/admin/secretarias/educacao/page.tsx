...
export default function SecretariaEducacaoPage() {
  ...
  } = useServiceSuggestions('educacao');
    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        const microSystems = Object.values(allMSConfigs).filter(
          (ms: any) => ms.departmentSlug === 'educacao'
        );
        ...
        return (
          <div className="space-y-4">
            <div className="flex items-center gap-3 border-b-2 pb-4 border-blue-500">
              ...
              <Badge className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-4 py-2 text-base shadow-lg">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {microSystems.map((msConfig: any) => (
                <Card
                  key={msConfig.id}
                  className="cursor-pointer hover:shadow-2xl transition-all duration-300 hover:scale-[1.03] border-2 border-blue-200 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50 dark:from-blue-950 dark:via-indigo-950 dark:to-blue-950 relative overflow-hidden group"
                ...
                >
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between mb-3">
                      <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg text-white">
                        {msConfig.icon}
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex gap-2 flex-wrap justify-center">
                        ...
                        {msConfig.hasWorkflow && (
                          <Badge variant="outline" className="text-xs bg-white/70 dark:bg-black/30 border-indigo-300">
                            Workflow
                          </Badge>
                        )}
                        {msConfig.hasReports && (
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <Button
                      variant="default"
                      className="w-full bg-blue-600 hover:bg-blue-700"
                      onClick={() => router.push(buildServiceCreationUrl('educacao', suggestion))}
                    >
                      <Plus className="h-4 w-4 mr-2" />
                      Criar este Serviço
                    </Button>
              ...
              <Card className="border-dashed border-2 border-blue-300 bg-gradient-to-br from-blue-50 to-indigo-50 hover:shadow-lg transition-all">
                <CardContent className="flex flex-col items-center justify-center p-12 h-full min-h-[300px]">
                  ...
                  <Button
                    ...
                    onClick={() => router.push(`/admin/secretarias/educacao/sugestoes`)}
                  >
