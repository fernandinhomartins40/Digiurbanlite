...
export default function SecretariaAssistenciaSocialPage() {
  ...
  // ✅ NOVO: Buscar sugestões inteligentes de serviços
  const {
    displayedSuggestions,
    hasMore,
    totalAvailable,
    isLoading: suggestionsLoading
  } = useServiceSuggestions('assistencia-social');
    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        const microSystems = Object.values(allMSConfigs).filter(
          (ms: any) => ms.departmentSlug === 'assistencia-social'
        );
        ...
        return (
          <div className="space-y-4">
            {/* Header da seção */}
            <div className="flex items-center gap-3 border-b-2 pb-4 border-purple-500">
              ...
              <Badge className="bg-gradient-to-r from-purple-500 to-pink-600 text-white px-4 py-2 text-base shadow-lg">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {microSystems.map((msConfig: any) => (
                <Card
                  key={msConfig.id}
                  className="cursor-pointer hover:shadow-2xl transition-all duration-300 hover:scale-[1.03] border-2 border-purple-200 bg-gradient-to-br from-purple-50 via-pink-50 to-purple-50 dark:from-purple-950 dark:via-pink-950 dark:to-purple-950 relative overflow-hidden group"
                ...
                >
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between mb-3">
                      <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center shadow-lg text-white">
                        {msConfig.icon}
                      </div>
                      <Badge variant="secondary" className="bg-gradient-to-r from-purple-500 to-pink-600 text-white border-0 shadow-md">
                        SUPER APP
                      </Badge>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="bg-purple-50 dark:bg-purple-950/50 rounded-lg p-3 border border-purple-200 dark:border-purple-800">
                        <p className="text-xs text-center text-purple-700 dark:text-purple-300 font-medium">
            ...
            modules.map((module: any, index: number) => {
              ...
              return (
                <Card
                  ...
                  onClick={() => router.push(`/admin/secretarias/assistencia-social/${module.moduleType}`)}
                >
                  <CardHeader>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card
            ...
            onClick={() => router.push('/admin/secretarias/assistencia-social/servicos-gerais')}
          >
            <CardHeader>
              <CardTitle className="text-lg flex items-center gap-2">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <Button
                      variant="default"
                      className="w-full bg-blue-600 hover:bg-blue-700"
                      onClick={() => router.push(buildServiceCreationUrl('assistencia-social', suggestion))}
                    >
                      <Plus className="h-4 w-4 mr-2" />
                      Criar este Serviço
                    </Button>
              ...
              <Card className="border-dashed border-2 border-blue-300 bg-gradient-to-br from-blue-50 to-indigo-50 hover:shadow-lg transition-all">
                <CardContent className="flex flex-col items-center justify-center p-12 h-full min-h-[300px]">
                  ...
                  <Button
                    ...
                    onClick={() => router.push(`/admin/secretarias/assistencia-social/sugestoes`)}
                  >
...
{/* Modal de Seleção de Serviços */}
      <ServiceSelectorModal
        ...
        departmentFilter="assistencia-social"
      />
    </div>
  );
}
