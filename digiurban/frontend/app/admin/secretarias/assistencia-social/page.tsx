      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex-1">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 flex items-center flex-wrap gap-3">
            <HandHeart className="h-7 w-7 md:h-8 md:w-8 text-pink-600 flex-shrink-0" />
        ...
        <Badge variant="outline" className="text-pink-600 border-pink-200 self-start md:self-auto">
          SUAS Municipal
        </Badge>
      </div>
