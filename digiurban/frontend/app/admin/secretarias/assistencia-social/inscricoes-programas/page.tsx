...
import { socialProgramEnrollmentConfig } from '@/lib/module-configs/assistencia-social';
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Inscrições em programas: Bolsa Família, BPC, PETI, habitação
        </p>
      </div>
      ...
      <Tabs defaultValue="cadastrados" className="w-full">
        ...
        <TabsContent value="cadastrados" className="mt-6">
          <ModulePageTemplate
            config={socialProgramEnrollmentConfig}
        ...
        <TabsContent value="pendentes" className="mt-6">
          <PendingProtocolsList
            moduleType="INSCRICOES_PROGRAMAS"
            moduleName="Programas Sociais"
          />
        </TabsContent>
      </Tabs>
    </div>
