...
export default function SecretariaTecnologiaInovacaoPage() {
  ...
  const {
    ...
    error: servicesError
  } = useSecretariaServices('tecnologia-inovacao');

  const {
    stats: departmentStats,
    loading: departmentLoading,
  } = useDepartmentStats('tecnologia-inovacao');
  ...
  } = useServiceSuggestions('tecnologia-inovacao');
  ...
  const moduleColors = [
    ...
    { border: 'border-sky-200', bg: 'bg-sky-50/50', icon: 'text-sky-600' },
    { border: 'border-cyan-300', bg: 'bg-cyan-50/50', icon: 'text-cyan-700' },
    { border: 'border-blue-300', bg: 'bg-blue-50/50', icon: 'text-blue-700' },
    { border: 'border-sky-300', bg: 'bg-sky-50/50', icon: 'text-sky-700' },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex-1">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 flex items-center flex-wrap gap-3">
            <Cpu className="h-7 w-7 md:h-8 md:w-8 text-cyan-600 flex-shrink-0" />
            <span>Secretaria de Tecnologia e Inovação</span>
          </h1>
          <p className="text-sm md:text-base text-gray-600 mt-1">
            Transformação digital e inclusão tecnológica
          </p>
        </div>
        <Badge variant="outline" className="text-cyan-600 border-cyan-200 self-start md:self-auto">
          Tecnologia
        </Badge>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Usuários Digitais</CardTitle>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">---</div>
            <p className="text-xs text-muted-foreground">Interconectados</p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Button
              className="h-20 flex flex-col"
              variant="outline"
              onClick={() => router.push('/admin/protocolos?departamento=tecnologia-inovacao&status=pending')}
            >
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {departmentLoading ? (
            ...
            modules.map((module: any, index: number) => {
              ...
              return (
                <Card
                  ...
                  onClick={() => router.push(`/admin/secretarias/tecnologia-inovacao/${module.moduleType}`)}
                >
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <Badge className="mb-2 bg-cyan-600 text-white">Módulo COM_DADOS</Badge>
                  ...
                  <CardContent>
                    <div className="text-sm space-y-2">
                      ...
                      <div className="flex justify-between items-center p-2 bg-cyan-50 rounded">
                        ...
                        <span className="font-semibold text-cyan-700">{module.stats?.pending || 0}</span>
                      </div>
                    ...
                    <Button className="w-full mt-4 group-hover:bg-cyan-600 transition-colors" variant="outline">
            ...
            <Card className="col-span-full border-cyan-200 bg-cyan-50">
              <CardContent className="flex flex-col items-center justify-center p-12 text-center">
                ...
                <Button
                  onClick={() => router.push('/admin/servicos/novo?departmentCode=TECNOLOGIA_INOVACAO&serviceType=COM_DADOS')}
      ...
      <div>
        ...
        {servicesLoading ? (
          ...
          <Card
            ...
            onClick={() => router.push('/admin/secretarias/tecnologia-inovacao/servicos-gerais')}
          >
            <CardHeader>
          ...
          <Card className="border-green-200 bg-green-50">
            <CardContent className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <Button
                onClick={() => router.push('/admin/servicos/novo?departmentCode=TECNOLOGIA_INOVACAO&serviceType=SEM_DADOS')}
        ...
        {suggestionsLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {displayedSuggestions.map((suggestion) => (
              <Card key={suggestion.id} className="border-cyan-200 bg-cyan-50/50 hover:shadow-lg transition-shadow">
                <CardHeader>
            ...
            {hasMore && (
              <Card className="border-dashed border-2 border-cyan-300 bg-gradient-to-br from-cyan-50 to-blue-50">
                <CardContent className="flex flex-col items-center justify-center p-12 h-full min-h-[300px]">
                  ...
                  <Button
                    ...
                    onClick={() => router.push(`/admin/secretarias/tecnologia-inovacao/sugestoes`)}
                  >
      ...
      <ServiceSelectorModal
        ...
        departmentFilter="tecnologia-inovacao"
      />
    </div>
  );
}
