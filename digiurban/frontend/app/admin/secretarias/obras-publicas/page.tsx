...
export default function SecretariaObrasPublicasPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Apps de Obras Públicas — sistemas especializados com tabelas próprias */}
      <div>
        <div className="mb-4">
          <h2 className="text-2xl font-semibold">Apps de Obras Públicas</h2>
          <p className="text-sm text-muted-foreground">
            Sistemas especializados completos, compartilhados com o Planejamento Urbano
          </p>
        </div>
