    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card exemplo 1: Solicitação de Reparo de Via */}
          <Card className="border-blue-200 bg-blue-50/50 hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-lg flex items-center gap-2">
                ...
                Solicitação de Reparo de Via
              </CardTitle>
              <CardDescription>
                Solicite reparo de buracos e pavimentação
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                ...
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => router.push('/admin/servicos/novo?departmentCode=obras-publicas&serviceType=COM_DADOS&template=reparo-via')}
                >
                  Criar este Serviço
                </Button>
              </div>
          ...
          {/* Card exemplo 2: Vistoria Técnica de Obras */}
          <Card className="border-green-200 bg-green-50/50 hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-lg flex items-center gap-2">
                <ClipboardCheck className="h-5 w-5 text-green-600" />
                Vistoria Técnica de Obras
              </CardTitle>
              <CardDescription>
                Solicite vistoria técnica em obras particulares
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                ...
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => router.push('/admin/servicos/novo?departmentCode=obras-publicas&serviceType=COM_DADOS&template=vistoria-obra')}
                >
                  Criar este Serviço
                </Button>
              </div>
          ...
          <Card className="border-dashed border-2 border-gray-300 hover:border-blue-500 transition-colors">
            <CardContent className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <Button
                variant="outline"
                onClick={() => router.push('/admin/servicos?serviceType=COM_DADOS&departmentCode=obras-publicas')}
              >
                Ver Todos
              </Button>
            </CardContent>
