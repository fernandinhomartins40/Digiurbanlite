    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        const microSystems = Object.values(allMSConfigs).filter(
          (ms: any) => ms.departmentSlug === 'obras-publicas'
        );
        ...
        return (
          <div className="space-y-4">
            {/* Header da seção */}
            <div className="flex items-center gap-3 border-b-2 pb-4 border-yellow-500">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {microSystems.map((msConfig: any) => (
                <Card
                  key={msConfig.id}
                  className="cursor-pointer hover:shadow-2xl transition-all duration-300 hover:scale-[1.03] border-2 border-yellow-200 bg-gradient-to-br from-yellow-50 via-orange-50 to-yellow-50 dark:from-yellow-950 dark:via-orange-950 dark:to-yellow-950 relative overflow-hidden group"
                ...
                >
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between mb-3">
                      <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-yellow-500 to-orange-600 flex items-center justify-center shadow-lg text-white">
                        {msConfig.icon}
                      </div>
                      <Badge variant="secondary" className="bg-gradient-to-r from-yellow-500 to-orange-600 text-white border-0 shadow-md">
                        SUPER APP
                      </Badge>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="bg-yellow-50 dark:bg-yellow-950/50 rounded-lg p-3 border border-yellow-200 dark:border-yellow-800">
                        <p className="text-xs text-center text-yellow-700 dark:text-yellow-300 font-medium">
                          ✨ Sistema completo pronto para uso
                        </p>
                      </div>

                      <div className="flex gap-2 flex-wrap justify-center">
                        <Badge variant="outline" className="text-xs bg-white/70 dark:bg-black/30 border-yellow-300">
                          Dashboard
                        </Badge>
                        {msConfig.hasWorkflow && (
                          <Badge variant="outline" className="text-xs bg-white/70 dark:bg-black/30 border-orange-300">
                            Workflow
                          </Badge>
                        )}
                        {msConfig.hasReports && (
            ...
            modules.map((module: any, index: number) => {
              ...
              return (
                <Card
                  ...
                  onClick={() => router.push(`/admin/secretarias/obras-publicas/${module.moduleType}`)}
                >
                  <CardHeader>
                    <CardTitle className="text-lg flex items-center gap-2">
                      <Construction className={`h-5 w-5 ${colors.icon}`} />
                      {module.name}
                    </CardTitle>
