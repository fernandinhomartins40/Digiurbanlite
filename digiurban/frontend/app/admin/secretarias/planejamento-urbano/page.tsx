...
export default function SecretariaPlanejamentoUrbanoPage() {
  ...
  } = useServiceSuggestions('planejamento-urbano');
    ...
    <div className="space-y-6">
      ...
      {(() => {
        ...
        const microSystems = Object.values(allMSConfigs).filter(
          (ms: any) => ms.departmentSlug === 'planejamento-urbano'
        );
        ...
        return (
          <div className="space-y-4">
            {/* Header da seção */}
            <div className="flex items-center gap-3 border-b-2 pb-4 border-slate-500">
              ...
              <Badge className="bg-gradient-to-r from-slate-500 to-gray-600 text-white px-4 py-2 text-base shadow-lg">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {microSystems.map((msConfig: any) => (
                <Card
                  key={msConfig.id}
                  className="cursor-pointer hover:shadow-2xl transition-all duration-300 hover:scale-[1.03] border-2 border-slate-200 bg-gradient-to-br from-slate-50 via-gray-50 to-slate-50 dark:from-slate-950 dark:via-gray-950 dark:to-slate-950 relative overflow-hidden group"
                ...
                >
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between mb-3">
                      <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-slate-500 to-gray-600 flex items-center justify-center shadow-lg text-white">
                        {msConfig.icon}
                      </div>
                      <Badge variant="secondary" className="bg-gradient-to-r from-slate-500 to-gray-600 text-white border-0 shadow-md">
                        SUPER APP
                      </Badge>
                    </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="bg-slate-50 dark:bg-slate-950/50 rounded-lg p-3 border border-slate-200 dark:border-slate-800">
                        <p className="text-xs text-center text-slate-700 dark:text-slate-300 font-medium">
                          ✨ Sistema completo pronto para uso
                        </p>
                      </div>

                      <div className="flex gap-2 flex-wrap justify-center">
                        <Badge variant="outline" className="text-xs bg-white/70 dark:bg-black/30 border-slate-300">
                          Dashboard
                        </Badge>
                        {msConfig.hasWorkflow && (
                          <Badge variant="outline" className="text-xs bg-white/70 dark:bg-black/30 border-gray-300">
                            Workflow
                          </Badge>
                        )}
                        {msConfig.hasReports && (
        ...
        {suggestionsLoading ? (
          ...
          <Card className="border-green-200 bg-green-50/50">
            <CardContent className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <Button
                onClick={() => router.push('/admin/servicos/novo?departmentCode=planejamento-urbano&serviceType=COM_DADOS')}
              ...
              <Card className="border-dashed border-2 border-blue-300 bg-gradient-to-br from-blue-50 to-indigo-50 hover:shadow-lg transition-all">
                <CardContent className="flex flex-col items-center justify-center p-12 h-full min-h-[300px]">
                  ...
                  <Button
                    ...
                    onClick={() => router.push(`/admin/secretarias/planejamento-urbano/sugestoes`)}
                  >
...
{/* Modal de Seleção de Serviços */}
      <ServiceSelectorModal
        ...
        departmentFilter="planejamento-urbano"
      />
    </div>
  );
}
