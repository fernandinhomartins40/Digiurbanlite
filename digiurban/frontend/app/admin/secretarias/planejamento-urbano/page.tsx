  ...
  return (
    <div className="space-y-6">
      ...
      {/* ========================================
          ...
          - Carregados dinamicamente do backend via useDepartmentStats
          - Cada módulo representa um conjunto de serviços COM_DADOS
          - Clique abre painel específico do módulo
          ======================================== */}
      <div>
        <div className="mb-6">
      ...
      {/* ========================================
          ...
          - Card agregado que mostra todos serviços SEM_DADOS
          - Clique abre view consolidada /servicos-gerais
          - Lista até 6 badges dos serviços
          ======================================== */}
      <div>
        <div className="mb-6">
