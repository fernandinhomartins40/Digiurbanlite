...
export default function PlanejamentoUrbanoSugestoesPage() {
  ...
  const { suggestions, isLoading } = useServiceSuggestions('planejamento-urbano');
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="mb-8">
        <Button
          variant="ghost"
          onClick={() => router.push('/admin/secretarias/planejamento-urbano')}
          className="mb-4"
        >
          <ArrowLeft className="h-4 w-4 mr-2" />
          Voltar para Planejamento Urbano
        </Button>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Explore todas as {suggestions.length} sugestões disponíveis para Planejamento Urbano
            </p>
          </div>
        </div>
      </div>
