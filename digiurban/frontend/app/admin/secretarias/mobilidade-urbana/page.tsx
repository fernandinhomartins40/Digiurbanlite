      ...
      <div>
        <div className="mb-6">
          <h2 className="text-2xl font-semibold flex items-center gap-2">
            <FileBarChart className="h-6 w-6 text-green-500" />
            Módulos de Gestão de Dados
          </h2>
            ...
            modules.map((module: any, index: number) => {
              ...
              return (
                <Card
                  ...
                  onClick={() => router.push(`/admin/secretarias/mobilidade-urbana/${module.moduleType}`)}
                >
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <Badge className="mb-2 bg-green-500 text-white">Módulo COM_DADOS</Badge>
                        <CardTitle className="text-lg flex items-center gap-2 group-hover:text-green-500 transition-colors">
                  ...
                  <CardContent>
                    <div className="text-sm space-y-2">
                      ...
                      <div className="flex justify-between items-center p-2 bg-green-50 rounded">
                        ...
                        <span className="font-semibold text-green-700">{module.stats?.pending || 0}</span>
                      </div>
                      <div className="flex justify-between items-center p-2 bg-green-50 rounded">
                    ...
                    <Button className="w-full mt-4 group-hover:bg-green-500 transition-colors" variant="outline">
      ...
      <div>
        ...
        {servicesLoading ? (
          ...
          <Card
            ...
            onClick={() => router.push('/admin/secretarias/mobilidade-urbana/servicos-gerais')}
          >
            <CardHeader>
          ...
          <Card className="border-green-200 bg-green-50">
            <CardContent className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <Button
                onClick={() => router.push('/admin/servicos/novo?departmentCode=MOBILIDADE_URBANA&serviceType=SEM_DADOS')}
