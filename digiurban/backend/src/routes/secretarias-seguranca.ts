...
router.get('/attendances', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
router.put('/attendances/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.delete('/attendances/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.get('/occurrences', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const page = parseInt(getStringParam(req.query.page) || '1');
  const limit = parseInt(getStringParam(req.query.limit) || '10');
  const search = getStringParam(req.query.search);
  const status = getStringParam(req.query.status);
...
router.put('/occurrences/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.delete('/occurrences/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.get('/patrol-requests', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const page = parseInt(getStringParam(req.query.page) || '1');
  const limit = parseInt(getStringParam(req.query.limit) || '10');
  const search = getStringParam(req.query.search);
  const status = getStringParam(req.query.status);
...
router.put('/patrol-requests/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.delete('/patrol-requests/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.get('/camera-requests', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const page = parseInt(getStringParam(req.query.page) || '1');
  const limit = parseInt(getStringParam(req.query.limit) || '10');
  const search = getStringParam(req.query.search);
  const status = getStringParam(req.query.status);
...
router.put('/camera-requests/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.delete('/camera-requests/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.get('/anonymous-tips', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const page = parseInt(getStringParam(req.query.page) || '1');
  const limit = parseInt(getStringParam(req.query.limit) || '10');
  const search = getStringParam(req.query.search);
  const status = getStringParam(req.query.status);
...
router.post('/anonymous-tips', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
router.put('/anonymous-tips/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.delete('/anonymous-tips/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.get('/critical-points', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const page = parseInt(getStringParam(req.query.page) || '1');
  const limit = parseInt(getStringParam(req.query.limit) || '10');
  const search = getStringParam(req.query.search);
  const skip = (page - 1) * limit;
...
router.post('/critical-points', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
router.put('/critical-points/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.delete('/critical-points/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.get('/alerts', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const page = parseInt(getStringParam(req.query.page) || '1');
  const limit = parseInt(getStringParam(req.query.limit) || '10');
  const search = getStringParam(req.query.search);
  const skip = (page - 1) * limit;
...
router.post('/alerts', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
router.put('/alerts/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.delete('/alerts/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.get('/patrols', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const page = parseInt(getStringParam(req.query.page) || '1');
  const limit = parseInt(getStringParam(req.query.limit) || '10');
  const search = getStringParam(req.query.search);
  const status = getStringParam(req.query.status);
...
router.post('/patrols', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
router.put('/patrols/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.delete('/patrols/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.get('/guards', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const page = parseInt(getStringParam(req.query.page) || '1');
  const limit = parseInt(getStringParam(req.query.limit) || '10');
  const search = getStringParam(req.query.search);
  const status = getStringParam(req.query.status);
...
router.post('/guards', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
router.put('/guards/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.delete('/guards/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.get('/surveillance-systems', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const page = parseInt(getStringParam(req.query.page) || '1');
  const limit = parseInt(getStringParam(req.query.limit) || '10');
  const search = getStringParam(req.query.search);
  const status = getStringParam(req.query.status);
...
router.post('/surveillance-systems', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
router.put('/surveillance-systems/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
...
router.delete('/surveillance-systems/:id', adminAuthMiddleware, requireMinRole(UserRole.MANAGER), asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
