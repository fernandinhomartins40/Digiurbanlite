...
// Secretarias
console.log('📋 Carregando rotas de secretarias...');
try { console.log('   → saude...'); app.use('/api/secretarias/saude', require('./routes/secretarias-saude').default); console.log('   ✓'); } catch (e) { console.error('❌ saude:', e); }
try { console.log('   → educacao...'); app.use('/api/admin/secretarias/educacao', require('./routes/secretarias-educacao').default); console.log('   ✓'); } catch (e) { console.error('❌ educacao:', e); }
try { console.log('   → assistencia...'); app.use('/api/secretarias/assistencia-social', require('./routes/secretarias-assistencia-social').default); console.log('   ✓'); } catch (e) { console.error('❌ assistencia:', e); }
try { console.log('   → agricultura...'); app.use('/api/admin/secretarias/agricultura', require('./routes/secretarias-agricultura').default); console.log('   ✓'); } catch (e) { console.error('❌ agricultura:', e); }
try { console.log('   → produtores...'); app.use('/api/admin/secretarias/agricultura/produtores', require('./routes/secretarias-agricultura-produtores').default); console.log('   ✓'); } catch (e) { console.error('❌ produtores:', e); }
try { console.log('   → cultura...'); app.use('/api/secretarias/cultura', require('./routes/secretarias-cultura').default); console.log('   ✓'); } catch (e) { console.error('❌ cultura:', e); }
try { console.log('   → esportes...'); app.use('/api/secretarias/esportes', require('./routes/secretarias-esportes').default); console.log('   ✓'); } catch (e) { console.error('❌ esportes:', e); }
try { console.log('   → habitacao...'); app.use('/api/secretarias/habitacao', require('./routes/secretarias-habitacao').default); console.log('   ✓'); } catch (e) { console.error('❌ habitacao:', e); }
try { console.log('   → seguranca...'); app.use('/api/admin/secretarias/seguranca', require('./routes/secretarias-seguranca').default); console.log('   ✓'); } catch (e) { console.error('❌ seguranca:', e); }
try { console.log('   → meio-ambiente...'); app.use('/api/admin/secretarias/meio-ambiente', require('./routes/secretarias-meio-ambiente').default); console.log('   ✓'); } catch (e) { console.error('❌ meio-ambiente:', e); }
try { console.log('   → obras...'); app.use('/api/admin/secretarias/obras-publicas', require('./routes/secretarias-obras-publicas').default); console.log('   ✓'); } catch (e) { console.error('❌ obras:', e); }
try { console.log('   → planejamento...'); app.use('/api/admin/secretarias/planejamento-urbano', require('./routes/secretarias-planejamento-urbano').default); console.log('   ✓'); } catch (e) { console.error('❌ planejamento:', e); }
try { console.log('   → servicos-publicos...'); app.use('/api/admin/secretarias/servicos-publicos', require('./routes/secretarias-servicos-publicos').default); console.log('   ✓'); } catch (e) { console.error('❌ servicos-publicos:', e); }
try { console.log('   → turismo...'); app.use('/api/admin/secretarias/turismo', require('./routes/secretarias-turismo').default); console.log('   ✓'); } catch (e) { console.error('❌ turismo:', e); }
try { console.log('   → admin-secretarias...'); app.use('/api/secretarias', require('./routes/admin-secretarias').default); console.log('   ✓'); } catch (e) { console.error('❌ admin-secretarias:', e); }
...
console.log('📝 Carregando rotas de protocolos complementares...');
