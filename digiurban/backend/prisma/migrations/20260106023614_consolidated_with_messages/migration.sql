...
-- CreateEnum
CREATE TYPE "TipoMedicamento" AS ENUM ('COMPRIMIDO', 'CAPSULA', 'SOLUCAO_ORAL', 'SUSPENSAO', 'POMADA', 'CREME', 'GEL', 'INJETAVEL', 'XAROPE', 'OUTRO');

-- CreateEnum
CREATE TYPE "UnidadeMedida" AS ENUM ('MG', 'G', 'ML', 'L', 'UNIDADE', 'FRASCO', 'AMPOLA', 'OUTRO');

-- CreateEnum
CREATE TYPE "StatusEstoque" AS ENUM ('DISPONIVEL', 'CRITICO', 'VENCIDO', 'BLOQUEADO');

-- CreateEnum
CREATE TYPE "StatusDispensacao" AS ENUM ('AGUARDANDO', 'DISPENSADO', 'PENDENTE', 'CANCELADO');
...
-- CreateEnum
CREATE TYPE "TipoTurma" AS ENUM ('REGULAR', 'INTEGRAL', 'EJA', 'ESPECIAL');

-- CreateEnum
CREATE TYPE "VeiculoStatus" AS ENUM ('DISPONIVEL', 'EM_USO', 'MANUTENCAO', 'INATIVO');

-- CreateEnum
CREATE TYPE "TipoMoradia" AS ENUM ('CASA', 'CASA_PROPRIA', 'APARTAMENTO', 'COMODO', 'BARRACO', 'OUTRO');

-- CreateEnum
CREATE TYPE "SituacaoMoradia" AS ENUM ('PROPRIA_QUITADA', 'PROPRIA_FINANCIADA', 'ADEQUADA', 'ALUGADA', 'CEDIDA', 'OCUPACAO', 'OUTRO');
...
-- CreateEnum
CREATE TYPE "GrauParentesco" AS ENUM ('RESPONSAVEL_FAMILIAR', 'CONJUGE_COMPANHEIRO', 'FILHO_ENTEADO', 'PAI_MAE', 'SOGRO_SOGRA', 'NETO_BISNETO', 'IRMAO_IRMA', 'GENRO_NORA', 'OUTRO');

-- CreateEnum
CREATE TYPE "SituacaoTrabalho" AS ENUM ('EMPREGADO_FORMAL', 'EMPREGADO_INFORMAL', 'AUTONOMO', 'DESEMPREGADO', 'APOSENTADO', 'PENSIONISTA', 'NAO_TRABALHA');

-- CreateEnum
CREATE TYPE "ProgramaSocialStatus" AS ENUM ('INSCRITO', 'VERIFICACAO_CADUNICO', 'NAO_ELEGIVEL', 'VERIFICACAO_APROVADA', 'AGUARDANDO_ANALISE', 'AGUARDANDO_VISITA', 'PARECER_FAVORAVEL', 'PARECER_DESFAVORAVEL', 'AGUARDANDO_PARECER_PSICOLOGICO', 'PARECER_PSICOLOGICO_CONCLUIDO', 'AGUARDANDO_APROVACAO', 'APROVADO', 'INDEFERIDO', 'CONCEDIDO', 'ATIVO', 'ATIVA', 'SUSPENSO', 'CANCELADO');
...
-- CreateEnum
CREATE TYPE "StatusPagamento" AS ENUM ('AGUARDANDO', 'PENDENTE', 'PROCESSANDO', 'PAGO', 'FALHA', 'ESTORNADO');
...
-- CreateEnum
CREATE TYPE "ChannelSubscriptionStatus" AS ENUM ('PENDING', 'ACTIVE', 'MUTED', 'BLOCKED');
...
CREATE TABLE "dispensacao_medicamentos" (
    ...
    "dispensadoEm" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateTable
CREATE TABLE "especialidades_tfd" (
    "id" TEXT NOT NULL,
    "nome" TEXT NOT NULL,
    "descricao" TEXT,
...
-- CreateIndex
CREATE INDEX "solicitacoes_tfd_protocolId_idx" ON "solicitacoes_tfd"("protocolId");

-- CreateIndex
CREATE INDEX "viagens_tfd_solicitacaoTFDId_idx" ON "viagens_tfd"("solicitacaoTFDId");

-- CreateIndex
CREATE INDEX "viagens_tfd_veiculoId_idx" ON "viagens_tfd"("veiculoId");

-- CreateIndex
CREATE INDEX "viagens_tfd_motoristaId_idx" ON "viagens_tfd"("motoristaId");
...
-- CreateIndex
CREATE UNIQUE INDEX "especialidades_tfd_nome_key" ON "especialidades_tfd"("nome");

-- CreateIndex
CREATE INDEX "especialidades_tfd_ativo_idx" ON "especialidades_tfd"("ativo");

-- CreateIndex
CREATE INDEX "especialidades_tfd_ordem_idx" ON "especialidades_tfd"("ordem");

-- CreateIndex
CREATE INDEX "destinos_tfd_ativo_idx" ON "destinos_tfd"("ativo");

-- CreateIndex
CREATE INDEX "destinos_tfd_cidade_idx" ON "destinos_tfd"("cidade");

-- CreateIndex
CREATE UNIQUE INDEX "destinos_tfd_cidade_estado_hospital_key" ON "destinos_tfd"("cidade", "estado", "hospital");
...
-- CreateIndex
CREATE UNIQUE INDEX "cadunico_familias_numeroCadUnico_key" ON "cadunico_familias"("numeroCadUnico");
...
-- CreateIndex
CREATE INDEX "cadunico_familias_numeroCadUnico_idx" ON "cadunico_familias"("numeroCadUnico");
...
-- CreateIndex
CREATE INDEX "inscricoes_programas_sociais_programaSocialId_idx" ON "inscricoes_programas_sociais"("programaSocialId");
...
-- CreateIndex
CREATE UNIQUE INDEX "conversations_participant1Id_participant1Type_participant2I_key" ON "conversations"("participant1Id", "participant1Type", "participant2Id", "participant2Type", "protocolId");
...
-- AddForeignKey
ALTER TABLE "solicitacoes_tfd" ADD CONSTRAINT "solicitacoes_tfd_protocolId_fkey" FOREIGN KEY ("protocolId") REFERENCES "protocols_simplified"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "viagens_tfd" ADD CONSTRAINT "viagens_tfd_veiculoId_fkey" FOREIGN KEY ("veiculoId") REFERENCES "veiculos_tfd"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "viagens_tfd" ADD CONSTRAINT "viagens_tfd_motoristaId_fkey" FOREIGN KEY ("motoristaId") REFERENCES "motoristas_tfd"("id") ON DELETE SET NULL ON UPDATE CASCADE;
