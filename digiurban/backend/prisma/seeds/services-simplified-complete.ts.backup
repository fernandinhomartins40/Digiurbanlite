...
const HEALTH_SERVICES: ServiceDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'pontoReferencia', type: 'text', label: 'Ponto de Referência (opcional)', required: false, maxLength: 200 },

      // ========== BLOCO 2: DADOS DE SAÚDE ==========
      { name: 'cartaoSUS', type: 'text', label: 'Cartão SUS (CNS)', required: true, pattern: '^\\d{15}$', minLength: 15, maxLength: 15 },
      { name: 'possuiCartaoVacina', type: 'checkbox', label: 'Possui Cartão de Vacina?', required: false, defaultValue: false },
      { name: 'numeroCartaoVacina', type: 'text', label: 'Número do Cartão de Vacina', required: false, maxLength: 50 },
      { name: 'alergiasMedicamentos', type: 'textarea', label: 'Alergias a Medicamentos/Vacinas (se houver)', required: false, maxLength: 500 },
      {
      ...
      { name: 'gestante', type: 'checkbox', label: 'É Gestante?', required: false, defaultValue: false },
      { name: 'semanasGestacao', type: 'number', label: 'Semanas de Gestação', required: false, minimum: 1, maximum: 42 },
      { name: 'possuiComorbidade', type: 'checkbox', label: 'Possui Comorbidade?', required: false, defaultValue: false },
      { name: 'descricaoComorbidade', type: 'textarea', label: 'Descrição da Comorbidade', required: false, maxLength: 500 },

      // ========== BLOCO 4: AGENDAMENTO/LOCAL ==========
      { name: 'unidadePreferencial', type: 'text', label: 'Unidade de Saúde Preferencial', required: true, minLength: 3, maxLength: 200 },
      { name: 'dataPreferencial', type: 'date', label: 'Data Preferencial', required: false },
      {
        name: 'turnoPreferencial',
        type: 'select',
        label: 'Turno Preferencial',
        required: false,
        options: ['Manhã', 'Tarde', 'Qualquer']
      },
      { name: 'temDificuldadeLocomocao', type: 'checkbox', label: 'Possui Dificuldade de Locomoção?', required: false, defaultValue: false },
      { name: 'solicitaVacinacaoDomiciliar', type: 'checkbox', label: 'Solicita Vacinação Domiciliar?', required: false, defaultValue: false },
      { name: 'justificativaVacinacaoDomiciliar', type: 'textarea', label: 'Justificativa para Vacinação Domiciliar', required: false, maxLength: 500 },

      // ========== BLOCO 5: OBSERVAÇÕES ==========
      { name: 'observacoes', type: 'textarea', label: 'Observações Gerais', required: false, maxLength: 500 }
    ]
  },
  {
    ...
    fields: [
      ...
      // ========== BLOCO 2: DADOS DE SAÚDE ==========
      { name: 'cartaoSUS', type: 'text', label: 'Cartão SUS (CNS)', required: true, pattern: '^\\d{15}$', minLength: 15, maxLength: 15 },
      { name: 'alergiasMedicamentos', type: 'textarea', label: 'Alergias a Medicamentos (se houver)', required: false, maxLength: 500 },
      {
        name: 'necessidadesEspeciais',
        type: 'select',
        label: 'Necessidades Especiais',
      ...
      { name: 'peso', type: 'number', label: 'Peso (kg)', required: false, minimum: 1, maximum: 300 },
      { name: 'altura', type: 'number', label: 'Altura (cm)', required: false, minimum: 40, maximum: 250 },
      ...
      { name: 'motivoInscricao', type: 'textarea', label: 'Motivo da Inscrição no Programa', required: true, minLength: 10, maxLength: 500 },
      { name: 'diagnostico', type: 'textarea', label: 'Diagnóstico Principal (CID-10)', required: true, minLength: 3, maxLength: 500 },
      { name: 'possuiDiagnosticoMedico', type: 'checkbox', label: 'Possui Diagnóstico Médico Formal?', required: false, defaultValue: false },
      { name: 'comorbidades', type: 'textarea', label: 'Comorbidades (outras doenças)', required: false, maxLength: 500 },

      // ========== BLOCO 4: MÉDICO RESPONSÁVEL ==========
      { name: 'nomeMedico', type: 'text', label: 'Nome do Médico Responsável', required: true, minLength: 3, maxLength: 200 },
      { name: 'crmMedico', type: 'text', label: 'CRM do Médico', required: true, pattern: '^\\d{4,8}$' },
      { name: 'especialidadeMedico', type: 'text', label: 'Especialidade do Médico', required: false, maxLength: 100 },
      { name: 'dataUltimaConsulta', type: 'date', label: 'Data da Última Consulta', required: false },

      // ========== BLOCO 5: ACOMPANHAMENTO ==========
      { name: 'dataInicio', type: 'date', label: 'Data de Início no Programa', required: true },
      { name: 'unidadeAcompanhamento', type: 'text', label: 'Unidade de Saúde para Acompanhamento', required: true, minLength: 3, maxLength: 200 },
      {
      ...
      { name: 'necessitaAcompanhante', type: 'checkbox', label: 'Necessita Acompanhante?', required: false, defaultValue: false },

      // ========== BLOCO 6: MEDICAMENTOS E TRATAMENTO ==========
      { name: 'fazUsoMedicamentoContinuo', type: 'checkbox', label: 'Faz Uso de Medicamento Contínuo?', required: false, defaultValue: false },
      { name: 'medicamentosUso', type: 'textarea', label: 'Medicamentos em Uso Contínuo', required: false, maxLength: 1000 },
      { name: 'possuiDificuldadeObterMedicamento', type: 'checkbox', label: 'Possui Dificuldade em Obter Medicamento?', required: false, defaultValue: false },
      { name: 'retiraraMedicamentoFarmaciaBasica', type: 'checkbox', label: 'Retirará Medicamentos na Farmácia Básica?', required: false, defaultValue: false },

      // ========== BLOCO 7: OBSERVAÇÕES ==========
      { name: 'observacoes', type: 'textarea', label: 'Observações Gerais', required: false, maxLength: 1000 }
    ]
  },
  {
...
const AGRICULTURE_SERVICES: ServiceDefinition[] = [
  ...
  // ============================================================================
  // SERVIÇOS SEM_DADOS - Certidões e Documentos (apenas protocolo)
  // ============================================================================
  {
    name: 'Certidão de Produtor Rural',
    description: 'Emissão de certidão comprovando a condição de produtor rural cadastrado',
    departmentCode: 'AGRICULTURA',
    serviceType: 'SEM_DADOS',
    moduleType: null,
    requiresDocuments: true,
...
const EDUCATION_SERVICES: ServiceDefinition[] = [
  ...
  },
  {
    ...
    formSchema: {
      type: 'object',
      properties: {
        nome: { type: 'string', title: 'Nome Completo do Nutricionista/Gestor', minLength: 3, maxLength: 200 },
        cpf: { type: 'string', title: 'CPF', pattern: '^\\d{11}$', minLength: 11, maxLength: 11 },
        rg: { type: 'string', title: 'RG', minLength: 5, maxLength: 20 },
        dataNascimento: { type: 'string', format: 'date', title: 'Data de Nascimento' },
        email: { type: 'string', format: 'email', title: 'E-mail' },
        ...
        rendaFamiliar: { type: 'string', title: 'Faixa de Renda Familiar', enum: ['Até 1 salário mínimo', '1 a 2 salários mínimos', '2 a 3 salários mínimos', '3 a 5 salários mínimos', 'Acima de 5 salários mínimos'] },
        nomeEscola: { type: 'string', title: 'Nome da Unidade Escolar', minLength: 3, maxLength: 200 },
        tipoCardapio: { type: 'string', title: 'Tipo de Cardápio', enum: ['Educação Infantil', 'Ensino Fundamental', 'Ensino Médio', 'EJA', 'Integral', 'Especial'] },
        periodoReferencia: { type: 'string', title: 'Período de Referência', enum: ['Semanal', 'Quinzenal', 'Mensal'] },
        numeroRefeicoes: { type: 'number', title: 'Número de Refeições/Dia', minimum: 1, maximum: 10 },
        numeroAlunos: { type: 'number', title: 'Número de Alunos Atendidos', minimum: 1 },
        restricoesDieteticas: { type: 'string', title: 'Restrições Dietéticas (alergias, intolerâncias)', maxLength: 500 },
        observacoes: { type: 'string', title: 'Observações', maxLength: 1000 },
      },
      required: ['nome', 'cpf', 'dataNascimento', 'email', 'telefone', 'cep', 'logradouro', 'numero', 'bairro', 'nomeMae', 'nomeEscola', 'tipoCardapio', 'periodoReferencia', 'numeroRefeicoes', 'numeroAlunos'],
    },
  },
  {
  ...
  // ========== SERVIÇOS SEM_DADOS (Certidões e Documentos) ==========
  {
    name: 'Declaração de Matrícula',
    description: 'Emissão de declaração comprovando matrícula ativa do aluno',
    departmentCode: 'EDUCACAO',
    serviceType: 'SEM_DADOS',
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: ['RG do Responsável', 'Comprovante de Matrícula'],
    estimatedDays: 3,
    priority: 3,
  ...
  },
  {
    ...
    description: 'Emissão de atestado comprovando frequência escolar',
    departmentCode: 'EDUCACAO',
    serviceType: 'SEM_DADOS',
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: ['RG do Responsável'],
    estimatedDays: 3,
    priority: 2,
    category: 'Declarações',
    icon: 'CheckCircle',
...
const SOCIAL_SERVICES: ServiceDefinition[] = [
  ...
  },
  {
    ...
    formSchema: {
      type: 'object',
      properties: {
        nome: { type: 'string', title: 'Nome Completo do Coordenador', minLength: 3, maxLength: 200 },
        cpf: { type: 'string', title: 'CPF', pattern: '^\\d{11}$', minLength: 11, maxLength: 11 },
        rg: { type: 'string', title: 'RG', minLength: 5, maxLength: 20 },
        dataNascimento: { type: 'string', format: 'date', title: 'Data de Nascimento' },
        email: { type: 'string', format: 'email', title: 'E-mail' },
  ...
  // ========================================
  // SERVIÇOS SEM_DADOS - ASSISTÊNCIA SOCIAL
  // ========================================
  {
...
const ENVIRONMENT_SERVICES: ServiceDefinition[] = [
  ...
  },
  {
    ...
    formSchema: {
      type: 'object',
      properties: {
        nome: { type: 'string', title: 'Nome Completo do Gestor Ambiental', minLength: 3, maxLength: 200 },
        cpf: { type: 'string', title: 'CPF', pattern: '^\\d{11}$', minLength: 11, maxLength: 11 },
        rg: { type: 'string', title: 'RG', minLength: 5, maxLength: 20 },
        dataNascimento: { type: 'string', format: 'date', title: 'Data de Nascimento' },
        email: { type: 'string', format: 'email', title: 'E-mail' },
  ...
  // MEIO AMBIENTE - Serviços SEM_DADOS
...
const PUBLIC_WORKS_SERVICES: ServiceDefinition[] = [
  ...
  // OBRAS PÚBLICAS - Serviços SEM_DADOS
...
const URBAN_PLANNING_SERVICES: ServiceDefinition[] = [
  ...
  },
  {
    ...
    description: 'Emissão de certidão informando uso permitido do solo',
    departmentCode: 'PLANEJAMENTO_URBANO',
    serviceType: 'SEM_DADOS',
    moduleType: null,
    requiresDocuments: true,
  ...
  },
  {
    ...
    description: 'Emissão de certidão com informações de zoneamento do lote',
    departmentCode: 'PLANEJAMENTO_URBANO',
    serviceType: 'SEM_DADOS',
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: ['CPF', 'RG', 'Comprovante de Endereço', 'Inscrição Imobiliária'],
    estimatedDays: 7,
    priority: 3,
    category: 'Certidões',
    icon: 'FileText',
  ...
  },
  {
    ...
    description: 'Emissão de declaração de conformidade com normas urbanísticas',
    departmentCode: 'PLANEJAMENTO_URBANO',
    serviceType: 'SEM_DADOS',
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: ['CPF', 'RG', 'Matrícula', 'Projeto Aprovado'],
    estimatedDays: 10,
    priority: 3,
    category: 'Declarações',
    icon: 'FileCheck',
  ...
  },
  {
    ...
    formSchema: {
      ...
      properties: {
        ...
        profissao: { type: 'string', title: 'Profissão/Ocupação', maxLength: 100 },
        rendaFamiliar: { type: 'string', title: 'Faixa de Renda Familiar', enum: ['Até 1 salário mínimo', '1 a 2 salários mínimos', '2 a 3 salários mínimos', '3 a 5 salários mínimos', 'Acima de 5 salários mínimos'] },
        localArvore: { type: 'string', title: 'Local da Árvore', maxLength: 300 },
        motivoPoda: { type: 'string', title: 'Motivo da Poda', enum: ['Galhos na Rede Elétrica', 'Risco de Queda', 'Obstrução de Visibilidade', 'Danificação de Calçada', 'Interferência em Iluminação', 'Outro'] },
        descricaoSituacao: { type: 'string', title: 'Descrição da Situação', minLength: 20, maxLength: 1000 },
        urgente: { type: 'boolean', title: 'Situação Urgente (risco iminente)?' },
        observacoes: { type: 'string', title: 'Observações', maxLength: 500 },
      },
      required: ['nome', 'cpf', 'dataNascimento', 'email', 'telefone', 'cep', 'logradouro', 'numero', 'bairro', 'nomeMae', 'localArvore', 'motivoPoda', 'descricaoSituacao'],
    },
  },
  {
  ...
  },
  {
    ...
    formSchema: {
      ...
      properties: {
        ...
        profissao: { type: 'string', title: 'Profissão/Ocupação', maxLength: 100 },
        rendaFamiliar: { type: 'string', title: 'Faixa de Renda Familiar', enum: ['Até 1 salário mínimo', '1 a 2 salários mínimos', '2 a 3 salários mínimos', '3 a 5 salários mínimos', 'Acima de 5 salários mínimos'] },
        tipoEquipe: { type: 'string', title: 'Tipo de Equipe', enum: ['Limpeza Urbana', 'Coleta de Lixo', 'Poda de Árvores', 'Iluminação Pública', 'Capina', 'Desobstrução', 'Equipe Mista'] },
        numeroEquipe: { type: 'string', title: 'Número da Equipe', maxLength: 50 },
        dataServico: { type: 'string', format: 'date', title: 'Data do Serviço' },
        horarioInicio: { type: 'string', title: 'Horário de Início', pattern: '^([01]\\d|2[0-3]):([0-5]\\d)$' },
        horarioTermino: { type: 'string', title: 'Horário de Término', pattern: '^([01]\\d|2[0-3]):([0-5]\\d)$' },
        rotaTrabalho: { type: 'string', title: 'Rota de Trabalho (ruas/bairros)', minLength: 10, maxLength: 1000 },
        observacoes: { type: 'string', title: 'Observações', maxLength: 500 },
      },
      required: ['nome', 'cpf', 'dataNascimento', 'email', 'telefone', 'cep', 'logradouro', 'numero', 'bairro', 'nomeMae', 'tipoEquipe', 'numeroEquipe', 'dataServico', 'horarioInicio', 'horarioTermino', 'rotaTrabalho'],
    },
  },
  {
...
const TOURISM_SERVICES: ServiceDefinition[] = [
  {
    ...
    formSchema: {
      ...
      properties: {
        ...
        profissao: { type: 'string', title: 'Profissão/Ocupação', maxLength: 100 },
        rendaFamiliar: { type: 'string', title: 'Faixa de Renda Familiar', enum: ['Até 1 salário mínimo', '1 a 2 salários mínimos', '2 a 3 salários mínimos', '3 a 5 salários mínimos', 'Acima de 5 salários mínimos'] },
        motivoAtendimento: { type: 'string', title: 'Motivo do Atendimento', enum: ['Informações Turísticas', 'Cadastro de Estabelecimento', 'Cadastro de Guia', 'Programa Turístico', 'Evento', 'Reclamação', 'Outro'] },
        descricaoAtendimento: { type: 'string', title: 'Descrição do Atendimento', minLength: 10, maxLength: 1000 },
        observacoes: { type: 'string', title: 'Observações', maxLength: 500 }
      },
      required: ['nome', 'cpf', 'dataNascimento', 'email', 'telefone', 'cep', 'logradouro', 'numero', 'bairro', 'nomeMae', 'motivoAtendimento', 'descricaoAtendimento']
  ...
  },
  {
    ...
    formSchema: {
      ...
      properties: {
        ...
        telefone: { type: 'string', title: 'Telefone Principal', pattern: '^\\d{10,11}$' },
        telefoneSecundario: { type: 'string', title: 'Telefone Secundário', pattern: '^\\d{10,11}$' },
        cep: { type: 'string', title: 'CEP do Responsável', pattern: '^\\d{8}$' },
        logradouro: { type: 'string', title: 'Rua/Avenida do Responsável', minLength: 3, maxLength: 200 },
        numero: { type: 'string', title: 'Número do Responsável', maxLength: 10 },
        complemento: { type: 'string', title: 'Complemento', maxLength: 100 },
        bairro: { type: 'string', title: 'Bairro do Responsável', minLength: 2, maxLength: 100 },
        pontoReferencia: { type: 'string', title: 'Ponto de Referência', maxLength: 200 },
        nomeMae: { type: 'string', title: 'Nome da Mãe', minLength: 3, maxLength: 200 },
        estadoCivil: { type: 'string', title: 'Estado Civil', enum: ['Solteiro(a)', 'Casado(a)', 'Divorciado(a)', 'Viúvo(a)', 'União Estável'] },
        profissao: { type: 'string', title: 'Profissão/Ocupação', maxLength: 100 },
        rendaFamiliar: { type: 'string', title: 'Faixa de Renda Familiar', enum: ['Até 1 salário mínimo', '1 a 2 salários mínimos', '2 a 3 salários mínimos', '3 a 5 salários mínimos', 'Acima de 5 salários mínimos'] },
        nomeEstabelecimento: { type: 'string', title: 'Nome do Estabelecimento', minLength: 3, maxLength: 200 },
        tipoEstabelecimento: { type: 'string', title: 'Tipo de Estabelecimento', enum: ['Hotel', 'Pousada', 'Hostel', 'Restaurante', 'Bar', 'Lanchonete', 'Agência de Turismo', 'Outro'] },
        cnpj: { type: 'string', title: 'CNPJ', pattern: '^\\d{14}$', minLength: 14, maxLength: 14 },
        enderecoEstabelecimento: { type: 'string', title: 'Endereço do Estabelecimento', minLength: 10, maxLength: 300 },
        cepEstabelecimento: { type: 'string', title: 'CEP do Estabelecimento', pattern: '^\\d{8}$' },
        telefoneEstabelecimento: { type: 'string', title: 'Telefone do Estabelecimento', pattern: '^\\d{10,11}$' },
        emailEstabelecimento: { type: 'string', format: 'email', title: 'E-mail do Estabelecimento' },
        capacidadeAtendimento: { type: 'integer', title: 'Capacidade de Atendimento', minimum: 1 },
        descricaoServicos: { type: 'string', title: 'Descrição dos Serviços', minLength: 30, maxLength: 1000 },
        horarioFuncionamento: { type: 'string', title: 'Horário de Funcionamento', maxLength: 200 },
        observacoes: { type: 'string', title: 'Observações', maxLength: 500 }
      },
      required: ['nome', 'cpf', 'dataNascimento', 'email', 'telefone', 'cep', 'logradouro', 'numero', 'bairro', 'nomeMae', 'nomeEstabelecimento', 'tipoEstabelecimento', 'cnpj', 'enderecoEstabelecimento', 'telefoneEstabelecimento']
    }
  },
  {
    ...
    formSchema: {
      ...
      properties: {
        ...
        profissao: { type: 'string', title: 'Profissão/Ocupação', maxLength: 100 },
        rendaFamiliar: { type: 'string', title: 'Faixa de Renda Familiar', enum: ['Até 1 salário mínimo', '1 a 2 salários mínimos', '2 a 3 salários mínimos', '3 a 5 salários mínimos', 'Acima de 5 salários mínimos'] },
        numeroCadastur: { type: 'string', title: 'Número do Cadastur', maxLength: 50 },
        especialidades: { type: 'string', title: 'Especialidades', maxLength: 300 },
        idiomas: { type: 'string', title: 'Idiomas que Fala', maxLength: 200 },
        tempoExperiencia: { type: 'string', title: 'Tempo de Experiência', enum: ['Menos de 1 ano', '1-3 anos', '3-5 anos', '5-10 anos', 'Mais de 10 anos'] },
        certificacoes: { type: 'string', title: 'Certificações e Cursos', maxLength: 500 },
        observacoes: { type: 'string', title: 'Observações', maxLength: 500 }
      },
      required: ['nome', 'cpf', 'dataNascimento', 'email', 'telefone', 'cep', 'logradouro', 'numero', 'bairro', 'nomeMae', 'numeroCadastur', 'especialidades', 'idiomas']
    }
  },
  {
    ...
    formSchema: {
      ...
      properties: {
        ...
        rendaFamiliar: { type: 'string', title: 'Faixa de Renda Familiar', enum: ['Até 1 salário mínimo', '1 a 2 salários mínimos', '2 a 3 salários mínimos', '3 a 5 salários mínimos', 'Acima de 5 salários mínimos'] },
        nomePrograma: { type: 'string', title: 'Nome do Programa', maxLength: 200 },
        tipoPrograma: { type: 'string', title: 'Tipo de Programa', enum: ['Qualificação Profissional', 'Desenvolvimento de Produto', 'Marketing Turístico', 'Infraestrutura', 'Outro'] },
        tipoInscrito: { type: 'string', title: 'Tipo de Inscrito', enum: ['Pessoa Física', 'Pessoa Jurídica'] },
        cnpj: { type: 'string', title: 'CNPJ (se pessoa jurídica)', pattern: '^\\d{14}$' },
        descricaoProjeto: { type: 'string', title: 'Descrição do Projeto', minLength: 50, maxLength: 1000 },
        observacoes: { type: 'string', title: 'Observações', maxLength: 500 }
      },
      required: ['nome', 'cpf', 'dataNascimento', 'email', 'telefone', 'cep', 'logradouro', 'numero', 'bairro', 'nomeMae', 'nomePrograma', 'tipoPrograma', 'tipoInscrito', 'descricaoProjeto']
    }
  },
  {
    ...
    formSchema: {
      ...
      properties: {
        ...
        profissao: { type: 'string', title: 'Profissão/Ocupação', maxLength: 100 },
        rendaFamiliar: { type: 'string', title: 'Faixa de Renda Familiar', enum: ['Até 1 salário mínimo', '1 a 2 salários mínimos', '2 a 3 salários mínimos', '3 a 5 salários mínimos', 'Acima de 5 salários mínimos'] },
        nomeAtrativo: { type: 'string', title: 'Nome do Atrativo', minLength: 3, maxLength: 200 },
        tipoAtrativo: { type: 'string', title: 'Tipo de Atrativo', enum: ['Natural', 'Cultural', 'Histórico', 'Religioso', 'Gastronômico', 'Esportivo', 'Outro'] },
        descricaoAtrativo: { type: 'string', title: 'Descrição do Atrativo', minLength: 50, maxLength: 1000 },
        enderecoAtrativo: { type: 'string', title: 'Endereço do Atrativo', minLength: 10, maxLength: 300 },
        acessibilidade: { type: 'string', title: 'Acessibilidade', enum: ['Total', 'Parcial', 'Não Possui'] },
        horarioFuncionamento: { type: 'string', title: 'Horário de Funcionamento', maxLength: 200 },
        valorEntrada: { type: 'string', title: 'Valor da Entrada', enum: ['Gratuito', 'Pago'] },
        observacoes: { type: 'string', title: 'Observações', maxLength: 500 }
      },
      required: ['nome', 'cpf', 'dataNascimento', 'email', 'telefone', 'cep', 'logradouro', 'numero', 'bairro', 'nomeMae', 'nomeAtrativo', 'tipoAtrativo', 'descricaoAtrativo', 'enderecoAtrativo']
    }
  },
  {
    ...
    formSchema: {
      ...
      properties: {
        ...
        profissao: { type: 'string', title: 'Profissão/Ocupação', maxLength: 100 },
        rendaFamiliar: { type: 'string', title: 'Faixa de Renda Familiar', enum: ['Até 1 salário mínimo', '1 a 2 salários mínimos', '2 a 3 salários mínimos', '3 a 5 salários mínimos', 'Acima de 5 salários mínimos'] },
        nomeRoteiro: { type: 'string', title: 'Nome do Roteiro', minLength: 3, maxLength: 200 },
        tipoRoteiro: { type: 'string', title: 'Tipo de Roteiro', enum: ['Histórico-Cultural', 'Ecoturismo', 'Gastronômico', 'Religioso', 'Aventura', 'Rural', 'Outro'] },
        descricaoRoteiro: { type: 'string', title: 'Descrição do Roteiro', minLength: 50, maxLength: 1000 },
        duracao: { type: 'string', title: 'Duração', enum: ['Meio Período', '1 Dia', '2 Dias', '3 ou mais Dias'] },
        pontosParada: { type: 'string', title: 'Pontos de Parada', minLength: 20, maxLength: 500 },
        nivelDificuldade: { type: 'string', title: 'Nível de Dificuldade', enum: ['Fácil', 'Moderado', 'Difícil'] },
        observacoes: { type: 'string', title: 'Observações', maxLength: 500 }
      },
      required: ['nome', 'cpf', 'dataNascimento', 'email', 'telefone', 'cep', 'logradouro', 'numero', 'bairro', 'nomeMae', 'nomeRoteiro', 'tipoRoteiro', 'descricaoRoteiro', 'duracao']
    }
  },
  {
    ...
    formSchema: {
      ...
      properties: {
        nome: { type: 'string', title: 'Nome Completo do Organizador', minLength: 3, maxLength: 200 },
        cpf: { type: 'string', title: 'CPF do Organizador', pattern: '^\\d{11}$', minLength: 11, maxLength: 11 },
        rg: { type: 'string', title: 'RG do Organizador', minLength: 5, maxLength: 20 },
        dataNascimento: { type: 'string', format: 'date', title: 'Data de Nascimento' },
        email: { type: 'string', format: 'email', title: 'E-mail' },
        telefone: { type: 'string', title: 'Telefone Principal', pattern: '^\\d{10,11}$' },
        telefoneSecundario: { type: 'string', title: 'Telefone Secundário', pattern: '^\\d{10,11}$' },
        ...
        rendaFamiliar: { type: 'string', title: 'Faixa de Renda Familiar', enum: ['Até 1 salário mínimo', '1 a 2 salários mínimos', '2 a 3 salários mínimos', '3 a 5 salários mínimos', 'Acima de 5 salários mínimos'] },
        nomeEvento: { type: 'string', title: 'Nome do Evento', minLength: 3, maxLength: 200 },
        tipoEvento: { type: 'string', title: 'Tipo de Evento', enum: ['Festival', 'Feira', 'Show', 'Congresso', 'Exposição', 'Competição Esportiva', 'Outro'] },
        descricaoEvento: { type: 'string', title: 'Descrição do Evento', minLength: 50, maxLength: 1000 },
        dataInicio: { type: 'string', format: 'date', title: 'Data de Início' },
        dataFim: { type: 'string', format: 'date', title: 'Data de Término' },
        localEvento: { type: 'string', title: 'Local do Evento', minLength: 10, maxLength: 300 },
        publicoEstimado: { type: 'integer', title: 'Público Estimado', minimum: 1 },
        observacoes: { type: 'string', title: 'Observações', maxLength: 500 }
      },
      required: ['nome', 'cpf', 'dataNascimento', 'email', 'telefone', 'cep', 'logradouro', 'numero', 'bairro', 'nomeMae', 'nomeEvento', 'tipoEvento', 'descricaoEvento', 'dataInicio', 'dataFim', 'localEvento']
    }
  },
  {
    name: 'Mapa Turístico',
