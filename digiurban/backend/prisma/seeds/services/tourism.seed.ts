...
export const tourismServices: ServiceDefinition[] = [
  ...
  },
  {
    ...
    requiredDocuments: [{ id: 'cnpj', name: 'CNPJ', required: true }, { id: 'alvara_funcionamento', name: 'Alvará de Funcionamento', required: true }, { id: 'documentacao_responsavel', name: 'Documentação do Responsável', required: true }],
    estimatedDays: 10,
    priority: 4,
    category: 'Cadastro',
    icon: 'Building',
  ...
  },
  {
    ...
    requiresDocuments: true,
    requiredDocuments: [{ id: 'rg', name: 'RG', required: true }, { id: 'cpf', name: 'CPF', required: true }, { id: 'cadastur', name: 'Cadastur', required: true }, { id: 'certificado_capacitacao', name: 'Certificado de Capacitação', required: true }],
    estimatedDays: 7,
    priority: 3,
    category: 'Cadastro',
    icon: 'User',
  ...
  },
  {
    ...
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cnpj_cpf', name: 'CNPJ ou CPF', required: true }, { id: 'projeto', name: 'Projeto', required: true }, { id: 'documentacao_estabelecimento', name: 'Documentação do Estabelecimento', required: true }],
    estimatedDays: 15,
    priority: 4,
    category: 'Programas',
    icon: 'FileCheck',
  ...
  },
  {
    ...
    requiresDocuments: true,
    requiredDocuments: [{ id: 'fotos', name: 'Fotos', required: true }, { id: 'descricao', name: 'Descrição', required: true }, { id: 'localizacao_gps', name: 'Localização GPS', required: true }],
    estimatedDays: 5,
    priority: 3,
    category: 'Atrativos',
    icon: 'MapPin',
  ...
  },
  {
    ...
    requiresDocuments: true,
    requiredDocuments: [{ id: 'roteiro_detalhado', name: 'Roteiro Detalhado', required: true }, { id: 'fotos', name: 'Fotos', required: true }, { id: 'valores', name: 'Valores', required: true }, { id: 'contatos', name: 'Contatos', required: true }],
    estimatedDays: 10,
    priority: 3,
    category: 'Roteiros',
    icon: 'Route',
  ...
  },
  {
    ...
    requiresDocuments: true,
    requiredDocuments: [{ id: 'projeto_evento', name: 'Projeto do Evento', required: true }, { id: 'autorizacoes', name: 'Autorizações', required: true }, { id: 'cronograma', name: 'Cronograma', required: true }],
    estimatedDays: 20,
    priority: 4,
    category: 'Eventos',
    icon: 'Calendar',
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'cnpj', name: 'CNPJ', required: true }, { id: 'alvara_funcionamento', name: 'Alvará de Funcionamento', required: true }],
    estimatedDays: 7,
    priority: 3,
    category: 'Certidões',
    icon: 'FileText',
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'cnpj', name: 'CNPJ', required: true }, { id: 'cadastro_turistico', name: 'Cadastro Turístico', required: true }],
    estimatedDays: 7,
    priority: 3,
    category: 'Certidões',
    icon: 'FileText',
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'projeto_evento', name: 'Projeto do Evento', required: true }, { id: 'cronograma', name: 'Cronograma', required: true }],
    estimatedDays: 10,
    priority: 3,
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'cnpj', name: 'CNPJ', required: true }, { id: 'cadastro_turistico', name: 'Cadastro Turístico', required: true }, { id: 'alvara', name: 'Alvará', required: true }],
    estimatedDays: 15,
    priority: 3,
    category: 'Laudos',
    icon: 'ClipboardCheck',
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'cnpj', name: 'CNPJ', required: true }, { id: 'projeto_uso_marca', name: 'Projeto de Uso da Marca', required: true }],
    estimatedDays: 20,
    priority: 4,
