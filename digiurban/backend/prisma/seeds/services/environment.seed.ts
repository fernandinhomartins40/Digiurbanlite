...
export const environmentServices: ServiceDefinition[] = [
  {
    ...
    requiredDocuments: [{ id: 'projeto', name: 'Projeto', required: true }, { id: 'estudo_impacto', name: 'Estudo de Impacto', required: true }, { id: 'art', name: 'ART', required: true }],
    estimatedDays: 60,
    priority: 5,
    category: 'Licenças',
    icon: 'Leaf',
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'matricula_imovel', name: 'Matrícula do Imóvel', required: true }],
    estimatedDays: 10,
    priority: 3,
    category: 'Certidões',
    icon: 'FileText',
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'licenca_ambiental', name: 'Licença Ambiental', required: true }],
    estimatedDays: 7,
    priority: 3,
  ...
  },
  {
    ...
    requiresDocuments: true,
    requiredDocuments: [{ id: 'foto_arvore', name: 'Foto da Árvore', required: true }, { id: 'laudo_tecnico', name: 'Laudo Técnico', required: true }, { id: 'comprovante_residencia', name: 'Comprovante de Residência', required: true }],
    estimatedDays: 15,
    priority: 4,
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'projeto', name: 'Projeto', required: true }, { id: 'estudos_ambientais', name: 'Estudos Ambientais', required: true }, { id: 'art_responsavel', name: 'ART do Responsável Técnico', required: true }],
      estimatedDays: 60,
      priority: 5,
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'rg', name: 'RG', required: true }, { id: 'cpf', name: 'CPF', required: true }, { id: 'comprovante_endereco', name: 'Comprovante de Endereço', required: true }],
      estimatedDays: 10,
      priority: 3,
      category: 'Programas',
      icon: 'GraduationCap',
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'laudo_tecnico', name: 'Laudo Técnico', required: true }, { id: 'fotos', name: 'Fotos', required: true }, { id: 'comprovante_propriedade', name: 'Comprovante de Propriedade', required: true }],
      estimatedDays: 15,
      priority: 4,
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'solicitacao_formal', name: 'Solicitação Formal', required: true }, { id: 'documentacao_imovel', name: 'Documentação do Imóvel', required: true }],
      estimatedDays: 20,
      priority: 3,
      category: 'Vistoria',
      icon: 'Search',
  ...
  {name: 'Certidão de Conformidade Ambiental', description: 'Certidão de conformidade com normas ambientais', departmentCode: 'MEIO_AMBIENTE', serviceType: 'SEM_DADOS', moduleType: null, requiresDocuments: true, requiredDocuments: [{ id: 'cnpj_cpf', name: 'CNPJ/CPF', required: true }, { id: 'documentos_imovel', name: 'Documentos do Imóvel', required: true }], estimatedDays: 10, priority: 4, category: 'Certidões', icon: 'FileText', color: '#f59e0b'},
  {name: 'Declaração de Área Verde', description: 'Declaração de área verde preservada', departmentCode: 'MEIO_AMBIENTE', serviceType: 'SEM_DADOS', moduleType: null, requiresDocuments: true, requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'planta_imovel', name: 'Planta do Imóvel', required: true }], estimatedDays: 7, priority: 3, category: 'Certidões', icon: 'Trees', color: '#10b981'},
  {name: 'Guia de Poda de Árvore', description: 'Autorização para poda de árvores', departmentCode: 'MEIO_AMBIENTE', serviceType: 'SEM_DADOS', moduleType: null, requiresDocuments: true, requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'comprovante_endereco', name: 'Comprovante de Endereço', required: true }, { id: 'fotos', name: 'Fotos', required: true }], estimatedDays: 5, priority: 4, category: 'Documentos', icon: 'Scissors', color: '#22c55e'},
  {name: 'Atestado de Coleta Seletiva', description: 'Atestado de participação em programa de coleta seletiva', departmentCode: 'MEIO_AMBIENTE', serviceType: 'SEM_DADOS', moduleType: null, requiresDocuments: true, requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }], estimatedDays: 3, priority: 2, category: 'Certidões', icon: 'Recycle', color: '#3b82f6'},
  {name: 'Consulta de Licença Ambiental', description: 'Consulta de situação de licenças ambientais', departmentCode: 'MEIO_AMBIENTE', serviceType: 'SEM_DADOS', moduleType: null, requiresDocuments: true, requiredDocuments: [{ id: 'cnpj_cpf', name: 'CNPJ/CPF', required: true }], estimatedDays: 2, priority: 3, category: 'Consultas', icon: 'Search', color: '#8b5cf6'},
  {name: 'Segunda Via de Autorização Ambiental', description: 'Reemissão de autorizações ambientais', departmentCode: 'MEIO_AMBIENTE', serviceType: 'SEM_DADOS', moduleType: null, requiresDocuments: true, requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'protocolo_original', name: 'Protocolo Original', required: true }], estimatedDays: 5, priority: 2, category: 'Documentos', icon: 'Copy', color: '#6b7280'}
];
