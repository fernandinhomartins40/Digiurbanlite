...
export const educationServices: ServiceDefinition[] = [
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'certidao_de_nascimento', name: 'Certidão de Nascimento', required: true }, { id: 'rg_do_responsavel', name: 'RG do Responsável', required: true }, { id: 'comprovante_de_endereco', name: 'Comprovante de Endereço', required: true }, { id: 'cartao_de_vacina', name: 'Cartão de Vacina', required: true }],
      estimatedDays: 7,
      priority: 5,
      category: 'Matrícula',
      icon: 'UserPlus',
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'comprovante_de_matricula', name: 'Comprovante de Matrícula', required: true }, { id: 'comprovante_de_endereco', name: 'Comprovante de Endereço', required: true }],
      estimatedDays: 10,
      priority: 4,
      category: 'Transporte',
      icon: 'Bus',
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'rg', name: 'RG', required: true }, { id: 'comprovante_de_matricula', name: 'Comprovante de Matrícula', required: true }],
      estimatedDays: 5,
      priority: 3,
      category: 'Documentos',
      icon: 'FileText',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'rg_do_responsavel', name: 'RG do Responsável', required: true }, { id: 'rg_do_aluno_se_possuir', name: 'RG do Aluno (se possuir)', required: true }],
      estimatedDays: 7,
      priority: 4,
      category: 'Documentos',
      icon: 'ScrollText',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'rg_do_responsavel', name: 'RG do Responsável', required: true }, { id: 'comprovante_de_conclusao', name: 'Comprovante de Conclusão', required: true }],
      estimatedDays: 5,
      priority: 3,
      category: 'Declarações',
      icon: 'Award',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'rg_do_responsavel', name: 'RG do Responsável', required: true }, { id: 'boletim_de_ocorrencia_se_perdaroubo', name: 'Boletim de Ocorrência (se perda/roubo)', required: true }],
      estimatedDays: 7,
      priority: 3,
      category: 'Documentos',
      icon: 'Copy',
