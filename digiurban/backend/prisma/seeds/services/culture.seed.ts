...
export const cultureServices: ServiceDefinition[] = [
  ...
  },
  {
    ...
    requiresDocuments: true,
    requiredDocuments: [{ id: 'portfolio', name: 'Portfólio', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'cpf', name: 'CPF', required: true }],
    estimatedDays: 10,
    priority: 4,
    category: 'Cadastro',
    icon: 'Mic',
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'nome_evento', name: 'Nome do Evento', required: true }],
    estimatedDays: 5,
    priority: 2,
    category: 'Certidões',
    icon: 'FileText',
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'projeto_cultural', name: 'Projeto Cultural', required: true }],
    estimatedDays: 10,
    priority: 3,
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'comprovante_inscricao', name: 'Comprovante de Inscrição', required: true }],
    estimatedDays: 5,
    priority: 2,
    category: 'Atestados',
    icon: 'CheckCircle',
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'documentacao_bem', name: 'Documentação do Bem', required: true }],
    estimatedDays: 20,
    priority: 4,
    category: 'Laudos',
    icon: 'ClipboardCheck',
  ...
  },
  {
    ...
    moduleType: null,
    requiresDocuments: true,
    requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'projeto_evento', name: 'Projeto do Evento', required: true }, { id: 'autorizacoes', name: 'Autorizações', required: true }],
    estimatedDays: 15,
    priority: 4,
  ...
  },
  {
    ...
    requiresDocuments: true,
    requiredDocuments: [{ id: 'projeto', name: 'Projeto', required: true }, { id: 'orcamento', name: 'Orçamento', required: true }, { id: 'documentos_pessoais', name: 'Documentos Pessoais', required: true }],
    estimatedDays: 30,
    priority: 5,
    category: 'Editais',
    icon: 'FilePen',
    ...
    },
  {
      ...
      requiredDocuments: [
        ...
        { id: 'projeto_evento', name: 'Projeto do Evento', required: true }
      ],
      estimatedDays: 10,
      priority: 3,
      category: 'Reserva',
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [
        { id: 'documentos_integrantes', name: 'Documentos dos Integrantes', required: true },
        { id: 'portfolio', name: 'Portfólio', required: true },
        { id: 'estatuto', name: 'Estatuto (se houver)', required: false }
      ],
      estimatedDays: 7,
      priority: 3,
      category: 'Cadastro',
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'projeto_detalhado', name: 'Projeto Detalhado', required: true }, { id: 'orcamento', name: 'Orçamento', required: true }, { id: 'curriculo_proponente', name: 'Currículo do Proponente', required: true }],
      estimatedDays: 30,
      priority: 4,
      category: 'Projetos',
      icon: 'FileText',
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'projeto_detalhado', name: 'Projeto Detalhado', required: true }, { id: 'orcamento', name: 'Orçamento', required: true }, { id: 'documentacao_legal', name: 'Documentação Legal', required: true }, { id: 'plano_divulgacao', name: 'Plano de Divulgação', required: true }],
      estimatedDays: 45,
      priority: 5,
      category: 'Incentivo',
      icon: 'DollarSign',
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'projeto_evento', name: 'Projeto do Evento', required: true }, { id: 'autorizacoes_necessarias', name: 'Autorizações Necessárias', required: true }],
      estimatedDays: 15,
      priority: 3,
      category: 'Eventos',
      icon: 'Calendar',
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'documentacao_historica', name: 'Documentação Histórica', required: true }, { id: 'fotos', name: 'Fotos', required: true }, { id: 'depoimentos', name: 'Depoimentos', required: true }],
      estimatedDays: 60,
      priority: 4,
      category: 'Patrimônio',
      icon: 'Landmark',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'portfolio_artistico', name: 'Portfólio Artístico', required: true }],
      estimatedDays: 5,
      priority: 3,
      category: 'Certidões',
      icon: 'FileText',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'comprovante_participacao', name: 'Comprovante de Participação', required: true }],
      estimatedDays: 3,
      priority: 3,
      category: 'Certidões',
      icon: 'FileCheck',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'projeto_cultural', name: 'Projeto Cultural', required: true }, { id: 'cronograma', name: 'Cronograma', required: true }],
      estimatedDays: 7,
      priority: 4,
      category: 'Documentos',
      icon: 'Building',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'estatuto_grupo', name: 'Estatuto do Grupo', required: true }],
      estimatedDays: 5,
      priority: 3,
      category: 'Certidões',
      icon: 'Users',
