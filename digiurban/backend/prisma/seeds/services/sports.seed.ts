...
export const sportsServices: ServiceDefinition[] = [
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'rg', name: 'RG', required: true }, { id: 'cpf', name: 'CPF', required: true }, { id: 'termo_responsabilidade', name: 'Termo de Responsabilidade', required: true }],
      estimatedDays: 3,
      priority: 3,
      category: 'Reserva',
      icon: 'Building',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'foto_3x4', name: 'Foto 3x4', required: true }],
      estimatedDays: 5,
      priority: 2,
      category: 'Documentos',
      icon: 'Copy',
