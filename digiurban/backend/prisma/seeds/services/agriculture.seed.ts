...
export const agricultureServices: ServiceDefinition[] = [
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cadastro_de_produtor', name: 'Cadastro de Produtor', required: true }, { id: 'documento_da_propriedade', name: 'Documento da Propriedade', required: true }],
      estimatedDays: 15,
      priority: 4,
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cadastro_de_produtor', name: 'Cadastro de Produtor', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'cpf', name: 'CPF', required: true }],
      estimatedDays: 5,
      priority: 3,
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cadastro_de_produtor', name: 'Cadastro de Produtor', required: true }, { id: 'dap', name: 'DAP', required: true }, { id: 'documentacao_da_propriedade', name: 'Documentação da Propriedade', required: true }],
      estimatedDays: 20,
      priority: 5,
      category: 'Programas',
      icon: 'FileCheck',
    ...
    },
  {
      ...
      requiresDocuments: true,
      requiredDocuments: [{ id: 'escritura_ou_contrato', name: 'Escritura ou Contrato', required: true }, { id: 'car_cadastro_ambiental_rural', name: 'CAR (Cadastro Ambiental Rural)', required: true }, { id: 'itr', name: 'ITR', required: true }],
      estimatedDays: 30,
      priority: 4,
      category: 'Cadastro',
      icon: 'Map',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'documento_da_propriedade', name: 'Documento da Propriedade', required: true }],
      estimatedDays: 5,
      priority: 3,
      category: 'Certidões',
      icon: 'FileCheck',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cadastro_de_produtor', name: 'Cadastro de Produtor', required: true }, { id: 'nota_fiscal_ou_documento_de_origem', name: 'Nota Fiscal ou Documento de Origem', required: true }],
      estimatedDays: 2,
      priority: 4,
      category: 'Documentos',
      icon: 'Truck',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cadastro_de_produtor', name: 'Cadastro de Produtor', required: true }, { id: 'documento_da_propriedade', name: 'Documento da Propriedade', required: true }, { id: 'laudo_tecnico', name: 'Laudo Técnico', required: true }],
      estimatedDays: 7,
      priority: 3,
      category: 'Certidões',
      icon: 'MapPin',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cpf_do_responsavel', name: 'CPF do Responsável', required: true }, { id: 'certidao_de_nascimento', name: 'Certidão de Nascimento', required: true }],
      estimatedDays: 2,
      priority: 3,
      category: 'Certidões',
      icon: 'FileText',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cpf_do_responsavel', name: 'CPF do Responsável', required: true }],
      estimatedDays: 3,
      priority: 3,
      category: 'Certidões',
      icon: 'CalendarCheck',
    ...
    },
  {
      ...
      moduleType: null,
      requiresDocuments: true,
      requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'boletim_de_ocorrencia', name: 'Boletim de Ocorrência', required: true }],
      estimatedDays: 5,
      priority: 2,
      category: 'Documentos',
      icon: 'Copy',
