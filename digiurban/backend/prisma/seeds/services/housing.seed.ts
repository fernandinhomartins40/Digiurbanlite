...
export const housingServices: ServiceDefinition[] = [
  ...
  {name: 'Segunda Via de Contrato Habitacional', description: 'Reemissão de contrato habitacional', departmentCode: 'HABITACAO', serviceType: 'SEM_DADOS', moduleType: null, requiresDocuments: true, requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'rg', name: 'RG', required: true }, { id: 'protocolo_original', name: 'Protocolo Original', required: false }], estimatedDays: 5, priority: 2, category: 'Documentos', icon: 'Copy', color: '#6b7280'},
  {name: 'Comprovante de Cadastro Habitacional', description: 'Comprovante oficial de cadastro habitacional', departmentCode: 'HABITACAO', serviceType: 'SEM_DADOS', moduleType: null, requiresDocuments: true, requiredDocuments: [{ id: 'cpf', name: 'CPF', required: true }, { id: 'comprovante_cadastro', name: 'Comprovante de Cadastro', required: true }], estimatedDays: 2, priority: 3, category: 'Documentos', icon: 'FileText', color: '#ec4899'}
];
