...
> **Progresso:** ✅ F0 (schema/migration/RLS/GIN, em produção) · ✅ F1 (importador de metadados) · ✅ F2 (motor de query + rotas `/api/registry/*`) · ✅ F3 (materialização + backfill + shadow-read atrás de `REGISTRY_READ`) · ⬜ F4–F7.
