    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          examesComuns: data.examesComuns ? JSON.stringify(data.examesComuns) : '',
        });
      } else {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Editar Especialidade Médica</h1>
          <p className="text-gray-600">Atualizar informações da especialidade</p>
        </div>
      </div>
